...
Ext.define("Traccar.AttributeFormatter", {
    ...
    numberFormatterFactory: function(precision, suffix) {
        return function(value) {
            return void 0 !== value ? Number(value.toFixed(precision)) + " " + suffix : null;
        };
    },
    ...
    courseFormatter: function(value) {
        return "N NE E SE S SW W NW".split(" ")[Math.floor(value / 45)];
    },
    ...
    geofenceIdFormatter: function(value) {
        if (0 !== value) {
            ...
            0 === store.getTotalCount() && (store = Ext.getStore("Geofences"));
            return (value = store.getById(value)) ? value.get("name") : "";
        }
        return null;
    },
    ...
    driverUniqueIdFormatter: function(value) {
        if (0 !== value) {
            ...
            return (driver = driver.findRecord("uniqueId", value, 0, !1, !0, !0)) ? value + " (" + driver.get("name") + ")" : value;
        }
        return null;
    },
    ...
    lastUpdateFormatter: function(value) {
        if (value) {
            ...
            interval = Math.floor(value / 3600);
    ...
    defaultFormatter: function(value) {
        return "number" === typeof value ?
            Number(value.toFixed(Traccar.Style.numberPrecision)) :
            "boolean" === typeof value ?
            value ?
            Ext.Msg.buttonText.yes :
            Ext.Msg.buttonText.no :
            value instanceof Date ?
            Traccar.app.getPreference("twelveHourFormat", !1) ?
            Ext.Date.format(value, Traccar.Style.dateTimeFormat12) :
            Ext.Date.format(value, Traccar.Style.dateTimeFormat24) :
            value;
    },
    ...
    renderAttribute: function(value, attribute) {
        return attribute && "speed" === attribute.get("dataType") ?
            Ext.getStore("SpeedUnits").formatValue(value, Traccar.app.getAttributePreference("speedUnit", "kn"), !0) :
            attribute && "distance" === attribute.get("dataType") ?
            Ext.getStore("DistanceUnits").formatValue(value, Traccar.app.getAttributePreference("distanceUnit", "km"), !0) :
            attribute && "hours" === attribute.get("dataType") ?
            Ext.getStore("HoursUnits").formatValue(value, "h", !0) :
            value;
    },
});
Ext.define("Traccar.model.Server", {
    ...
    fields: [
        ...
        { name: "deviceReadonly", type: "boolean" },
        { name: "limitCommands", type: "boolean" },
        ...
        { name: "zoom", type: "int" },
        { name: "twelveHourFormat", type: "boolean" },
        { name: "forceSettings", type: "boolean" },
        { name: "coordinateFormat", type: "string" },
        { name: "poiLayer", type: "string" },
        { name: "attributes" },
    ],
...
Ext.define("Traccar.model.Device", {
    ...
    fields: [
        ...
        { name: "phone", type: "string", allowNull: !0 },
        { name: "model", type: "string", allowNull: !0 },
        { name: "contact", type: "string", allowNull: !0 },
        { name: "category", type: "string", allowNull: !0 },
        { name: "status", type: "string", allowNull: !0 },
...
Ext.define("Traccar.model.Position", {
    ...
    fields: [
        ...
        { name: "deviceTime", type: "date", dateFormat: "c" },
        { name: "fixTime", type: "date", dateFormat: "c" },
        { name: "valid", type: "boolean" },
        { name: "accuracy", type: "float", convert: Traccar.AttributeFormatter.getConverter("accuracy") },
        { name: "latitude", type: "float" },
        { name: "longitude", type: "float" },
        { name: "altitude", type: "float" },
        { name: "speed", type: "float", convert: Traccar.AttributeFormatter.getConverter("speed") },
...
Ext.define("Traccar.model.Command", {
    extend: Ext.data.Model,
    identifier: "negative",
    fields: [{ name: "id", type: "int" }, { name: "description", type: "string" }, { name: "deviceId", type: "int" }, { name: "type", type: "string" }, { name: "textChannel", type: "boolean" }, { name: "attributes" }],
});
Ext.define("Traccar.model.Event", {
    ...
    fields: [
        ...
        { name: "maintenanceId", type: "int" },
        {
            name: "text",
            convert: function(v, rec) {
                var geofence;
                "commandResult" === rec.get("type") ?
                    (v = Strings.eventCommandResult + ": " + rec.get("attributes").result) :
                    "alarm" === rec.get("type") ?
                    ((v = rec.get("attributes").alarm), (v = "alarm" + v.charAt(0).toUpperCase() + v.slice(1)), (v = Strings[v] || v)) :
                    (v =
                        "textMessage" === rec.get("type") ?
                        Strings.eventTextMessage + ": " + rec.get("attributes").message :
                        "driverChanged" === rec.get("type") ?
                        Strings.eventDriverChanged + ": " + Traccar.AttributeFormatter.driverUniqueIdFormatter(rec.get("attributes").driverUniqueId) :
                        Traccar.app.getEventString(rec.get("type")));
                rec.get("geofenceId") && (geofence = Ext.getStore("Geofences").getById(rec.get("geofenceId"))) && (v += ' "' + geofence.get("name") + '"');
                rec.get("maintenanceId") && (rec = Ext.getStore("Maintenances").getById(rec.get("maintenanceId"))) && (v += ' "' + rec.get("name") + '"');
                return v;
            },
...
Ext.define("Traccar.model.Geofence", {
    extend: Ext.data.Model,
    identifier: "negative",
    fields: [{ name: "id", type: "int" }, { name: "name", type: "string" }, { name: "description", type: "string" }, { name: "area", type: "string" }, { name: "calendarId", type: "int" }, { name: "attributes" }],
});
Ext.define("Traccar.model.Notification", {
    extend: Ext.data.Model,
    identifier: "negative",
    fields: [{ name: "id", type: "int" }, { name: "type", type: "string" }, { name: "always", type: "bool" }, { name: "attributes" }, { name: "notificators", type: "string" }, { name: "calendarId", type: "int" }],
});
Ext.define("Traccar.model.ReportSummary", {
    ...
    fields: [
        ...
        { name: "maxSpeed", type: "float", convert: Traccar.AttributeFormatter.getConverter("speed") },
        { name: "averageSpeed", type: "float", convert: Traccar.AttributeFormatter.getConverter("speed") },
        { name: "distance", type: "float", convert: Traccar.AttributeFormatter.getConverter("distance") },
        { name: "startOdometer", type: "float", convert: Traccar.AttributeFormatter.getConverter("distance") },
        { name: "endOdometer", type: "float", convert: Traccar.AttributeFormatter.getConverter("distance") },
        { name: "engineHours", type: "int" },
        { name: "spentFuel", type: "float", convert: Traccar.AttributeFormatter.getConverter("spentFuel") },
    ],
});
Ext.define("Traccar.model.ReportTrip", {
    ...
    fields: [
        ...
        { name: "startAddress", type: "string" },
        { name: "endTime", type: "date", dateFormat: "c" },
        { name: "endAddress", type: "string" },
        { name: "spentFuel", type: "float", convert: Traccar.AttributeFormatter.getConverter("spentFuel") },
        { name: "driverUniqueId", type: "string" },
...
Ext.define("Traccar.model.Maintenance", {
    extend: Ext.data.Model,
    identifier: "negative",
    fields: [{ name: "id", type: "int" }, { name: "name", type: "string" }, { name: "type", type: "string" }, { name: "start", type: "float" }, { name: "period", type: "float" }, { name: "attributes" }],
});
...
Ext.define("Traccar.store.AlarmTypes", {
    ...
    data: (function() {
        var key,
            items = [];
        for (key in Strings) Strings.hasOwnProperty(key) && 0 === key.lastIndexOf("alarm", 0) && items.push({ key: key.charAt(5).toLowerCase() + key.slice(6), name: Strings[key] });
        return items;
    })(),
});
...
Ext.define("Traccar.store.MapTypes", {
    ...
    fields: ["key", "name"],
    data: [
        { key: "carto", name: Strings.mapCarto },
        ...
        { key: "baidu", name: Strings.mapBaidu },
        { key: "yandexMap", name: Strings.mapYandexMap },
        { key: "yandexSat", name: Strings.mapYandexSat },
        { key: "wikimedia", name: Strings.mapWikimedia },
...
Ext.define("Traccar.store.DistanceUnits", {
    ...
    data: [
        { key: "km", name: Strings.sharedKm, factor: 0.001 },
        { key: "mi", name: Strings.sharedMi, factor: 6.21371e-4 },
        { key: "nmi", name: Strings.sharedNmi, factor: 5.39957e-4 },
    ],
...
Ext.define("Traccar.store.SpeedUnits", {
    ...
    fields: ["key", "name", "factor"],
    data: [
        { key: "kn", name: Strings.sharedKn, factor: 1 },
        { key: "kmh", name: Strings.sharedKmh, factor: 1.852 },
        { key: "mph", name: Strings.sharedMph, factor: 1.15078 },
    ],
    convertValue: function(value, unit, back) {
        unit || (unit = "kn");
        unit = this.findRecord("key", unit);
...
Ext.define("Traccar.store.CoordinateFormats", {
    ...
    fields: ["key", "name"],
    data: [
        { key: "dd", name: Strings.sharedDecimalDegrees },
        { key: "ddm", name: Strings.sharedDegreesDecimalMinutes },
        { key: "dms", name: Strings.sharedDegreesMinutesSeconds },
    ],
...
Ext.define("Traccar.store.TimeUnits", {
    ...
    fields: ["key", "name", "factor"],
    data: [
        { key: "s", name: Strings.sharedSecondAbbreviation, factor: 1 },
        { key: "m", name: Strings.sharedMinuteAbbreviation, factor: 60 },
        { key: "h", name: Strings.sharedHourAbbreviation, factor: 3600 },
    ],
    convertValue: function(value, unit, back) {
        unit || (unit = "kn");
        unit = this.findRecord("key", unit);
...
Ext.define("Traccar.store.Languages", {
    ...
    data: (function() {
        var code,
            data = [];
        for (code in Locale.languages) Locale.languages.hasOwnProperty(code) && data.push({ code: code, name: Locale.languages[code].name });
        return data;
    })(),
});
...
Ext.define("Traccar.store.GeofenceTypes", {
    ...
    fields: ["key", "name"],
    data: [
        { key: "Polygon", name: Strings.mapShapePolygon },
        { key: "Circle", name: Strings.mapShapeCircle },
        { key: "LineString", name: Strings.mapShapePolyline },
    ],
});
...
Ext.define("Traccar.store.ReportTypes", {
    ...
    fields: ["key", "name"],
    data: [
        { key: "route", name: Strings.reportRoute },
        { key: "events", name: Strings.reportEvents },
        { key: "trips", name: Strings.reportTrips },
        { key: "stops", name: Strings.reportStops },
        { key: "summary", name: Strings.reportSummary },
        { key: "chart", name: Strings.reportChart },
    ],
});
...
Ext.define("Traccar.store.ReportChartTypes", {
    ...
    fields: ["key", "name"],
    data: [
        { key: "speed", name: Strings.positionSpeed },
        { key: "accuracy", name: Strings.positionAccuracy },
        { key: "altitude", name: Strings.positionAltitude },
    ],
});
Ext.define("Traccar.store.ReportPeriods", {
    ...
    fields: ["key", "name"],
    data: [
        { key: "custom", name: Strings.reportCustom },
        { key: "today", name: Strings.reportToday },
        { key: "yesterday", name: Strings.reportYesterday },
        { key: "thisWeek", name: Strings.reportThisWeek },
        { key: "previousWeek", name: Strings.reportPreviousWeek },
        { key: "thisMonth", name: Strings.reportThisMonth },
...
Ext.define("Traccar.model.Statistics", {
    ...
    fields: [
        { name: "id", type: "int" },
        { name: "captureTime", type: "date", dateFormat: "c" },
        { name: "activeUsers", type: "int" },
        { name: "activeDevices", type: "int" },
        { name: "requests", type: "int" },
        { name: "messagesReceived", type: "int" },
        { name: "messagesStored", type: "int" },
        { name: "mailSent", type: "int" },
        { name: "smsSent", type: "int" },
        { name: "geocoderRequests", type: "int" },
        { name: "geolocationRequests", type: "int" },
        { name: "attributes" },
    ],
});
    ...
    data: (function() {
        ...
        for (i = 0; i < window.Images.length; i++) {
            ...
            data.push({
                ...
                fillId: "arrow" === key ? "arrow" : "background",
                rotateId: "arrow" === key ? "arrow" : "background",
                scaleId: "arrow" === key ? "arrow" : "layer1",
            });
        }
        return data;
    })(),
...
Ext.define("Traccar.store.DeviceStatuses", {
    ...
    data: [
        { id: "online", name: Strings.deviceStatusOnline, color: "view-color-green" },
        { id: "offline", name: Strings.deviceStatusOffline, color: "view-color-red" },
        { id: "unknown", name: Strings.deviceStatusUnknown, color: "view-color-yellow" },
    ],
});
Ext.define("Traccar.store.CommonDeviceAttributes", {
    ...
    data: [
        { key: "speedLimit", name: Strings.attributeSpeedLimit, valueType: "number", dataType: "speed" },
        { key: "report.ignoreOdometer", name: Strings.attributeReportIgnoreOdometer, valueType: "boolean" },
    ],
});
Ext.define("Traccar.store.DeviceAttributes", {
    ...
    model: "Traccar.model.KnownAttribute",
    data: [
        { key: "web.reportColor", name: Strings.attributeWebReportColor, valueType: "color" },
        { key: "devicePassword", name: Strings.attributeDevicePassword, valueType: "string" },
        { key: "processing.copyAttributes", name: Strings.attributeProcessingCopyAttributes, valueType: "string" },
        { key: "decoder.timezone", name: Strings.sharedTimezone, valueType: "string", dataType: "timezone" },
    ],
});
Ext.define("Traccar.store.GeofenceAttributes", {
    ...
    proxy: "memory",
    data: [
        { key: "color", name: Strings.attributeColor, valueType: "color" },
        { key: "speedLimit", name: Strings.attributeSpeedLimit, valueType: "number", dataType: "speed" },
        { key: "polylineDistance", name: Strings.attributePolylineDistance, valueType: "number", dataType: "distance" },
    ],
});
...
Ext.define("Traccar.store.CommonUserAttributes", {
    ...
    model: "Traccar.model.KnownAttribute",
    data: [
        { key: "web.liveRouteLength", name: Strings.attributeWebLiveRouteLength, valueType: "number", allowDecimals: !1 },
        { key: "web.selectZoom", name: Strings.attributeWebSelectZoom, valueType: "number", allowDecimals: !1, minValue: Traccar.Style.mapDefaultZoom, maxValue: Traccar.Style.mapMaxZoom },
        { key: "web.maxZoom", name: Strings.attributeWebMaxZoom, valueType: "number", allowDecimals: !1, minValue: Traccar.Style.mapDefaultZoom, maxValue: Traccar.Style.mapMaxZoom },
        { key: "ui.disableReport", name: Strings.attributeUiDisableReport, valueType: "boolean" },
        { key: "ui.disableEvents", name: Strings.attributeUiDisableEvents, valueType: "boolean" },
        { key: "ui.disableVehicleFetures", name: Strings.attributeUiDisableVehicleFetures, valueType: "boolean" },
        { key: "ui.disableDrivers", name: Strings.attributeUiDisableDrivers, valueType: "boolean" },
        { key: "ui.disableComputedAttributes", name: Strings.attributeUiDisableComputedAttributes, valueType: "boolean" },
        { key: "ui.disableCalendars", name: Strings.attributeUiDisableCalendars, valueType: "boolean" },
        { key: "ui.disableMaintenance", name: Strings.attributeUiDisableMaintenance, valueType: "boolean" },
        { key: "ui.hidePositionAttributes", name: Strings.attributeUiHidePositionAttributes, valueType: "string" },
        { key: "distanceUnit", name: Strings.settingsDistanceUnit, valueType: "string", dataType: "distanceUnit" },
        { key: "speedUnit", name: Strings.settingsSpeedUnit, valueType: "string", dataType: "speedUnit" },
        { key: "volumeUnit", name: Strings.settingsVolumeUnit, valueType: "string", dataType: "volumeUnit" },
...
Ext.define("Traccar.store.UserAttributes", {
    ...
    model: "Traccar.model.KnownAttribute",
    data: [
        { key: "mail.smtp.host", name: Strings.attributeMailSmtpHost, valueType: "string" },
        { key: "mail.smtp.port", name: Strings.attributeMailSmtpPort, valueType: "number", allowDecimals: !1, minValue: 1, maxValue: 65535 },
        { key: "mail.smtp.starttls.enable", name: Strings.attributeMailSmtpStarttlsEnable, valueType: "boolean" },
        { key: "mail.smtp.starttls.required", name: Strings.attributeMailSmtpStarttlsRequired, valueType: "boolean" },
        { key: "mail.smtp.ssl.enable", name: Strings.attributeMailSmtpSslEnable, valueType: "boolean" },
        { key: "mail.smtp.ssl.trust", name: Strings.attributeMailSmtpSslTrust, valueType: "string" },
        { key: "mail.smtp.ssl.protocols", name: Strings.attributeMailSmtpSslProtocols, valueType: "string" },
        { key: "mail.smtp.from", name: Strings.attributeMailSmtpFrom, valueType: "string" },
        { key: "mail.smtp.auth", name: Strings.attributeMailSmtpAuth, valueType: "boolean" },
        { key: "mail.smtp.username", name: Strings.attributeMailSmtpUsername, valueType: "string" },
...
Ext.define("Traccar.store.PositionAttributes", {
    ...
    proxy: "memory",
    data: [
        { key: "raw", name: Strings.positionRaw, valueType: "string" },
        { key: "index", name: Strings.positionIndex, valueType: "number" },
        { key: "hdop", name: Strings.positionHdop, valueType: "number" },
        { key: "vdop", name: Strings.positionVdop, valueType: "number" },
        { key: "pdop", name: Strings.positionPdop, valueType: "number" },
        { key: "sat", name: Strings.positionSat, valueType: "number" },
        { key: "satVisible", name: Strings.positionSatVisible, valueType: "number" },
        { key: "rssi", name: Strings.positionRssi, valueType: "number" },
        { key: "gps", name: Strings.positionGps, valueType: "number" },
        { key: "roaming", name: Strings.positionRoaming, valueType: "boolean" },
        { key: "event", name: Strings.positionEvent, valueType: "string" },
        { key: "alarm", name: Strings.positionAlarm, valueType: "string" },
        { key: "status", name: Strings.positionStatus, valueType: "string" },
        { key: "odometer", name: Strings.positionOdometer, valueType: "number", dataType: "distance" },
        { key: "serviceOdometer", name: Strings.positionServiceOdometer, valueType: "number", dataType: "distance" },
        { key: "tripOdometer", name: Strings.positionTripOdometer, valueType: "number", dataType: "distance" },
        { key: "hours", name: Strings.positionHours, valueType: "number", dataType: "hours" },
        { key: "steps", name: Strings.positionSteps, valueType: "number" },
        { key: "input", name: Strings.positionInput, valueType: "string" },
        { key: "output", name: Strings.positionOutput, valueType: "string" },
        { key: "power", name: Strings.positionPower, valueType: "number", dataType: "voltage" },
        { key: "battery", name: Strings.positionBattery, valueType: "number", dataType: "voltage" },
        { key: "batteryLevel", name: Strings.positionBatteryLevel, valueType: "number", dataType: "percentage" },
        { key: "fuel", name: Strings.positionFuel, valueType: "number", dataType: "volume" },
        { key: "fuelConsumption", name: Strings.positionFuelConsumption, valueType: "number", dataType: "consumption" },
        { key: "versionFw", name: Strings.positionVersionFw, valueType: "string" },
        { key: "versionHw", name: Strings.positionVersionHw, valueType: "string" },
        { key: "type", name: Strings.sharedType, valueType: "string" },
        { key: "ignition", name: Strings.positionIgnition, valueType: "boolean" },
        { key: "flags", name: Strings.positionFlags, valueType: "string" },
        { key: "charge", name: Strings.positionCharge, valueType: "boolean" },
        { key: "ip", name: Strings.positionIp, valueType: "string" },
        { key: "archive", name: Strings.positionArchive, valueType: "boolean" },
        { key: "distance", name: Strings.positionDistance, valueType: "number", dataType: "distance" },
        { key: "totalDistance", name: Strings.deviceTotalDistance, valueType: "number", dataType: "distance" },
        { key: "rpm", name: Strings.positionRpm, valueType: "number" },
        { key: "vin", name: Strings.positionVin, valueType: "string" },
        { key: "approximate", name: Strings.positionApproximate, valueType: "boolean" },
        { key: "throttle", name: Strings.positionThrottle, valueType: "number" },
        { key: "motion", name: Strings.positionMotion, valueType: "boolean" },
        { key: "armed", name: Strings.positionArmed, valueType: "number" },
        { key: "geofence", name: Strings.sharedGeofence, valueType: "string" },
        { key: "acceleration", name: Strings.positionAcceleration, valueType: "number" },
        { key: "deviceTemp", name: Strings.positionDeviceTemp, valueType: "number", dataType: "temperature" },
        { key: "operator", name: Strings.positionOperator, valueType: "string" },
        { key: "command", name: Strings.deviceCommand, valueType: "string" },
        { key: "blocked", name: Strings.positionBlocked, valueType: "boolean" },
        { key: "dtcs", name: Strings.positionDtcs, valueType: "string" },
        { key: "obdSpeed", name: Strings.positionObdSpeed, valueType: "number", dataType: "speed" },
        { key: "obdOdometer", name: Strings.positionObdOdometer, valueType: "number", dataType: "distance" },
        { key: "result", name: Strings.eventCommandResult, valueType: "string" },
    ...
    getAttributeDataType: function(key) {
        return (key = this.getById(key)) && key.get("dataType") ? key.get("dataType") : null;
    },
});
Ext.define("Traccar.store.AttributeValueTypes", {
    ...
    proxy: "memory",
    data: [
        { id: "string", name: Strings.sharedTypeString },
        { id: "number", name: Strings.sharedTypeNumber },
        { id: "boolean", name: Strings.sharedTypeBoolean },
    ],
});
...
Ext.define("Traccar.store.KnownCommands", {
    ...
    model: "Traccar.model.KnownCommand",
    data: [
        { type: "custom", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        { type: "positionPeriodic", parameters: [{ key: "frequency", name: Strings.commandFrequency, valueType: "number", allowDecimals: !1, minValue: 0, dataType: "frequency" }] },
        { type: "setTimezone", parameters: [{ key: "timezone", name: Strings.commandTimezone, valueType: "string", dataType: "timezone" }] },
        {
            type: "sendSms",
            parameters: [
                { key: "phone", name: Strings.commandPhone, valueType: "string" },
                { key: "message", name: Strings.commandMessage, valueType: "string" },
            ],
        },
        { type: "message", parameters: [{ key: "message", name: Strings.commandMessage, valueType: "string" }] },
        { type: "sendUssd", parameters: [{ key: "phone", name: Strings.commandPhone, valueType: "string" }] },
        {
            type: "sosNumber",
            parameters: [
                { key: "index", name: Strings.commandIndex, valueType: "number", allowDecimals: !1, minValue: 0 },
                { key: "phone", name: Strings.commandPhone, valueType: "string" },
            ],
        },
        { type: "silenceTime", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        { type: "setPhonebook", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        { type: "voiceMessage", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        {
            type: "outputControl",
            parameters: [
                { key: "index", name: Strings.commandIndex, valueType: "number", allowDecimals: !1, minValue: 0 },
                { key: "data", name: Strings.commandData, valueType: "string" },
            ],
        },
        { type: "voiceMonitoring", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "setAgps", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "setIndicator", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        { type: "configuration", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        {
            type: "setConnection",
            parameters: [
                { key: "server", name: Strings.commandServer, valueType: "string" },
                { key: "port", name: Strings.commandPort, valueType: "number", allowDecimals: !1, minValue: 1, maxValue: 65535 },
            ],
        },
        { type: "setOdometer", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        { type: "modePowerSaving", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "modeDeepSleep", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "movementAlarm", parameters: [{ key: "radius", name: Strings.commandRadius, valueType: "number", allowDecimals: !1, minValue: 0 }] },
        { type: "alarmBattery", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "alarmSos", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "alarmRemove", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "alarmClock", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        { type: "alarmSpeed", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
        { type: "alarmFall", parameters: [{ key: "enable", name: Strings.commandEnable, valueType: "boolean" }] },
        { type: "alarmVibration", parameters: [{ key: "data", name: Strings.commandData, valueType: "string" }] },
    ],
});
Ext.define("Traccar.store.VolumeUnits", {
    ...
    data: [
        { key: "ltr", name: Strings.sharedLiterAbbreviation, fullName: Strings.sharedLiter, factor: 1 },
        { key: "impGal", name: Strings.sharedGallonAbbreviation, fullName: Strings.sharedImpGallon, factor: 4.546 },
        { key: "usGal", name: Strings.sharedGallonAbbreviation, fullName: Strings.sharedUsGallon, factor: 3.785 },
    ],
    convertValue: function(value, unit, back) {
        unit || (unit = "ltr");
        unit = this.findRecord("key", unit);
...
Ext.define("Traccar.store.HoursUnits", {
    ...
    data: [{ key: "h", name: Strings.sharedHourAbbreviation, fullName: Strings.sharedHour }],
    convertValue: function(value, unit, back) {
        return back ? 36e5 * value : value / 36e5;
    },
    formatValue: function(value, unit, convert) {
        convert ? ((unit = Math.floor(value / 36e5)), (value = Math.floor((value % 36e5) / 6e4))) : ((unit = Math.floor(value)), (value = Math.floor((value % 1) * 60)));
        return unit + " " + Strings.sharedHourAbbreviation + " " + value + " " + Strings.sharedMinuteAbbreviation;
    },
});
...
Ext.define("Traccar.view.dialog.RegisterController", {
    ...
    onCreateReturn: function(options, success, response) {
        success ? (this.closeView(), Traccar.app.showToast(Strings.loginCreated)) : Traccar.app.showError(response);
    },
});
Ext.define("Traccar.view.dialog.Register", {
    ...
    items: {
        ...
        jsonSubmit: !0,
        items: [
            { xtype: "textfield", name: "name", fieldLabel: Strings.sharedName, allowBlank: !1 },
            {
                xtype: "textfield",
                name: "email",
                fieldLabel: Strings.userEmail,
                validator: function(val) {
                    return /(.+)@(.+)\.(.{2,})/.test(val) ? !0 : Ext.form.field.VTypes.emailText;
                },
                allowBlank: !1,
            },
            { xtype: "textfield", name: "password", fieldLabel: Strings.userPassword, inputType: "password", allowBlank: !1 },
        ],
    },
    buttons: [
        { text: Strings.sharedSave, handler: "onCreateClick" },
...
Ext.define("Traccar.view.dialog.LoginController", {
    ...
    login: function() {
        var form = this.lookupReference("form");
        form.isValid() &&
            (Ext.get("spinner").setVisible(!0),
                this.getView().setVisible(!1),
                Ext.Ajax.request({
                    scope: this,
                    method: "POST",
                    url: "api/session",
                    ...
                    callback: function(options, success, response) {
                        ...
                        success
                            ?
                            (this.lookupReference("rememberField").getValue() &&
                            ...
                            (this.getView().setVisible(!0), 401 === response.status ? Traccar.app.showError(Strings.loginFailed) : Traccar.app.showError(response.responseText));
                    },
                }));
    },
    logout: function() {
    ...
    onSelectLanguage: function(selected) {
        ...
        if (0 <= url.indexOf("locale\x3d")) {
            var prefix = url.substring(0, url.indexOf("locale"));
...
Ext.define("Traccar.view.dialog.Login", {
    ...
    items: {
        ...
        items: [
            { xtype: "image", src: "ubik3.png", alt: Strings.loginLogo, width: 240, height: 84, style: { display: "block", margin: "10px auto 25px" } },
            {
                xtype: "combobox",
                hidden: 'true',
                name: "language",
                ...
                allowBlank: !1,
                enableKeyEvents: !0,
                listeners: { specialKey: "onSpecialKey", afterrender: "onAfterRender" },
                inputAttrTpl: ['autocomplete\x3d"on" autocapitalize\x3d"none"'],
            },
            {
                xtype: "textfield",
                name: "password",
            ...
            { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, reference: "rememberField", fieldLabel: Strings.userRemember },
            { xtype: "component", html: '\x3ciframe id\x3d"submitTarget" name\x3d"submitTarget" style\x3d"display:none"\x3e\x3c/iframe\x3e' },
            { xtype: "component", html: '\x3cinput type\x3d"submit" id\x3d"submitButton" style\x3d"display:none"\x3e' },
        ],
    },
    buttons: [
        { text: Strings.loginRegister, handler: "onRegisterClick", reference: "registerButton", hidden: true },
        { text: Strings.loginLogin, handler: "onLoginClick" },
    ],
});
        ...
        if ((newValue = combobox.getStore().getById(newValue))) {
            ...
            switch (newValue.get("valueType")) {
                case "number":
                    ...
                    combobox.dataType = newValue.get("dataType");
                ...
                case "color":
                    ...
                    break;
                default:
                    if (newValue.get("dataType"))
                        switch (((combobox.xtype = "combobox"), (combobox.queryMode = "local"), (combobox.editable = !1), newValue.get("dataType"))) {
                            case "distanceUnit":
            ...
            valueField.getXType() !== combobox.xtype || ("customNumberField" === combobox.xtype && valueField.dataType !== combobox.dataType) ?
                (this.getView().down("form").insert(this.getView().down("form").items.indexOf(valueField), combobox), this.getView().down("form").remove(valueField)) :
                "customNumberField" === combobox.xtype ?
                (valueField.setConfig(combobox), valueField.validate()) :
                "combobox" === combobox.xtype && (valueField.setConfig(combobox), valueField.setValue());
        }
    },
});
    ...
    constructor: function(config) {
        ...
        if (config.dataType) {
                    ...
                    config.listeners.afterrender = function() {
                        this.units ||
                            (this.units = Ext.create({
                                ...
                                listeners: {
                                    select: function() {
                                        this.numberField.step = this.getStore().convertValue(1, this.getValue(), !0);
                                    },
                                },
                            }));
                    };
            ...
            config.rawToValue = function(rawValue) {
                return this.units ? this.units.getStore().convertValue(this.parseValue(rawValue), this.units.getValue(), !0) : this.parseValue(rawValue);
            };
            config.valueToRaw = function(value) {
                return this.units ? String(this.units.getStore().convertValue(value, this.units.getValue(), !1)) : String(value);
            };
...
Ext.define("Traccar.view.dialog.Attribute", {
    ...
    items: {
        ...
        items: [
            { xtype: "unescapedTextField", reference: "nameTextField", name: "name", allowBlank: !1, fieldLabel: Strings.sharedName },
            { xtype: "textfield", name: "value", reference: "valueField", allowBlank: !1, fieldLabel: Strings.stateValue },
        ],
    },
    buttons: [
        { glyph: "xf00c@FontAwesome", reference: "saveButton", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, handler: "onSaveClick" },
...
Ext.define("Traccar.view.edit.AttributesController", {
    ...
    init: function() {
        ...
        for (propertyName in attributes) attributes.hasOwnProperty(propertyName) && store$jscomp$0.add(Ext.create("Traccar.model.Attribute", { priority: i++, name: propertyName, value: attributes[propertyName] }));
        store$jscomp$0.addListener(
            "add",
        ...
        store$jscomp$0.addListener(
            ...
            function(store, record, operation) {
                store = this.getView();
                operation === Ext.data.Model.EDIT &&
                    (record.modified.name !== record.get("name") && delete store.record.get("attributes")[record.modified.name], (store.record.get("attributes")[record.get("name")] = record.get("value")), (store.record.dirty = !0));
            },
            this
        );
        store$jscomp$0.addListener(
        ...
        this.getView().record instanceof Traccar.model.Device ?
            (this.getView().attributesStore = "DeviceAttributes") :
            this.getView().record instanceof Traccar.model.Geofence ?
            (this.getView().attributesStore = "GeofenceAttributes") :
            this.getView().record instanceof Traccar.model.Group ?
            (this.getView().attributesStore = "GroupAttributes") :
            this.getView().record instanceof Traccar.model.Server ?
            (this.getView().attributesStore = "ServerAttributes") :
            this.getView().record instanceof Traccar.model.User && (this.getView().attributesStore = "UserAttributes");
    },
    comboConfig: { xtype: "combobox", reference: "nameComboField", name: "name", fieldLabel: Strings.sharedName, displayField: "name", valueField: "key", allowBlank: !1, queryMode: "local", listeners: { change: "onNameChange" } },
...
Ext.define("Traccar.view.edit.Toolbar", {
    ...
    initComponent: function() {
        this.callParent(arguments);
        this.add(0, [
            { xtype: "button", handler: "onAddClick", reference: "toolbarAddButton", glyph: "xf067@FontAwesome", tooltip: Strings.sharedAdd, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onEditClick", reference: "toolbarEditButton", glyph: "xf040@FontAwesome", tooltip: Strings.sharedEdit, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onRemoveClick", reference: "toolbarRemoveButton", glyph: "xf00d@FontAwesome", tooltip: Strings.sharedRemove, tooltipType: "title" },
        ]);
    },
});
...
Ext.define("Traccar.view.dialog.BaseEditController", {
    ...
    onSaveClick: function(button) {
        ...
        (store = button.store) ?
        (button.phantom && store.add(button),
            store.sync({
                failure: function(batch) {
                    store.rejectChanges();
                    Traccar.app.showError(batch.exceptions[0].getError().response);
    ...
    onTypeChange: function(combo, newValue) {
        ...
        if ((newValue = Ext.getStore("KnownCommands").getById(newValue)) && newValue.get("parameters")) {
            ...
            for (newValue = 0; newValue < parameters.length; newValue++) {
                var parameter = new Traccar.model.KnownAttribute(parameters[newValue]);
                ...
                switch (parameter.get("valueType")) {
                    ...
                    case "boolean":
                        ...
                        break;
                    default:
                        "timezone" === parameter.get("dataType") ?
                            ((config.xtype = "combobox"), (config.queryMode = "local"), (config.displayField = "key"), (config.editable = !1), (config.store = "AllTimezones")) :
...
Ext.define("Traccar.view.permissions.BaseController", {
    ...
    init: function() {
        ...
        this.getView()
            ...
            .load({
                scope: this,
                callback: function() {
                    Ext.create("Traccar.store." + linkStoreName).load({
                        params: params,
                        scope: this,
    ...
    onBeforeSelect: function(selection, record) {
        ...
        Ext.Ajax.request({
            ...
            callback: function(options, success, response) {
                success || (selection.deselect(record, !0), Traccar.app.showError(response));
            },
        });
    },
...
Ext.define("Traccar.view.permissions.Base", {
    extend: Traccar.view.GridPanel,
    controller: "base",
    selModel: { selType: "checkboxmodel", checkOnly: !0, showHeaderCheckbox: !1 },
    listeners: { beforedeselect: "onBeforeDeselect", beforeselect: "onBeforeSelect" },
});
Ext.define("Traccar.view.permissions.SavedCommands", {
    ...
    columns: {
        items: [
            { text: Strings.sharedDescription, dataIndex: "description", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "string" },
            {
                text: Strings.sharedType,
                dataIndex: "type",
                flex: 1,
                minWidth: Traccar.Style.columnWidthNormal,
                filter: { type: "list", idField: "type", labelField: "name", store: "AllCommandTypes" },
                renderer: Traccar.AttributeFormatter.getFormatter("commandType"),
            },
            { text: Strings.commandSendSms, dataIndex: "textChannel", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "boolean" },
        ],
    },
});
Ext.define("Traccar.view.dialog.SendCommandController", {
    ...
    onValidityChange: function(form, valid) {
        this.lookupReference("sendButton").setDisabled(!valid || null === this.lookupReference("commandsComboBox").getValue());
    },
    ...
    onCommandSelect: function(selected) {
        ...
        if (selected && command.get("type") === selected.get("type")) this.onTypeChange(this.lookupReference("commandType"), command.get("type"));
    ...
    onSendResult: function(options, success, response) {
        success ? (this.closeView(), Traccar.app.showToast(202 === response.status ? Strings.commandQueued : Strings.commandSent)) : Traccar.app.showError(response);
    },
    closeView: function() {
...
Ext.define("Traccar.view.dialog.SendCommand", {
    ...
    items: [{
            ...
            editable: !1,
            allowBlank: !1,
            listeners: { select: "onCommandSelect" },
        },
        {
            xtype: "form",
            listeners: { validitychange: "onValidityChange" },
            items: [{
                ...
                disabled: !0,
                items: [
                    { xtype: "checkboxfield", name: "textChannel", reference: "textChannelCheckBox", inputValue: !0, uncheckedValue: !1, fieldLabel: Strings.commandSendSms, listeners: { change: "onTextChannelChange" } },
                    {
                        xtype: "combobox",
                        name: "type",
    ...
    buttons: [
        { xtype: "tbfill" },
        { glyph: "xf093@FontAwesome", tooltip: Strings.sharedSend, tooltipType: "title", minWidth: 0, disabled: !0, reference: "sendButton", handler: "onSendClick" },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
    ],
});
Ext.define("Traccar.view.dialog.BaseEdit", {
    ...
    controller: "baseEdit",
    buttons: [
        { text: Strings.sharedAttributes, handler: "showAttributesView" },
        { xtype: "tbfill" },
        { glyph: "xf00c@FontAwesome", reference: "saveButton", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, handler: "onSaveClick" },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
    ],
...
Ext.define("Traccar.view.dialog.DeviceController", {
    ...
    init: function() {
        Traccar.app.getUser().get("administrator") && this.lookupReference("disabledField").setHidden(!1);
    },
});
Ext.define("Traccar.view.dialog.Device", {
    ...
    items: {
        ...
        items: [{
                ...
                items: [
                    { xtype: "unescapedTextField", name: "name", fieldLabel: Strings.sharedName, allowBlank: !1 },
                    { xtype: "unescapedTextField", name: "uniqueId", fieldLabel: Strings.deviceIdentifier, allowBlank: !1 },
                ],
            },
            {
                xtype: "fieldset",
                ...
                collapsed: !0,
                items: [
                    { xtype: "clearableComboBox", name: "groupId", fieldLabel: Strings.groupParent, store: "Groups", queryMode: "local", displayField: "name", valueField: "id" },
                    { xtype: "unescapedTextField", name: "phone", fieldLabel: Strings.sharedPhone },
                    { xtype: "unescapedTextField", name: "model", fieldLabel: Strings.deviceModel },
                    { xtype: "unescapedTextField", name: "contact", fieldLabel: Strings.deviceContact },
                    {
                        xtype: "combobox",
                        name: "category",
                        ...
                        listConfig: {
                            getInnerTpl: function() {
                                return '\x3ctable\x3e\x3ctr valign\x3d"middle" \x3e\x3ctd\x3e\x3cdiv align\x3d"center" style\x3d"width:40px;height:40px;" \x3e{[new XMLSerializer().serializeToString(Traccar.DeviceImages.getImageSvg(Traccar.Style.mapColorOnline, false, 0, values.key))]}\x3c/div\x3e\x3c/td\x3e\x3ctd\x3e{name}\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e';
                            },
                        },
                    },
...
Ext.define("Traccar.view.permissions.Geofences", {
    ...
    columns: {
        items: [
            { text: Strings.sharedName, dataIndex: "name", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "string" },
            {
...
Ext.define("Traccar.view.permissions.Drivers", {
    ...
    columns: {
        items: [
            { text: Strings.sharedName, dataIndex: "name", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "string" },
            { text: Strings.deviceIdentifier, dataIndex: "uniqueId", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "string" },
        ],
    },
});
Ext.define("Traccar.view.edit.DevicesController", {
    ...
    config: {
        listen: {
            controller: { "*": { selectreport: "deselectDevice", selectevent: "deselectDevice" }, root: { selectdevice: "selectDevice" }, map: { selectdevice: "selectDevice", deselectfeature: "deselectFeature" } },
            store: { "#Devices": { update: "onUpdateDevice" } },
        },
    },
    ...
    onSelectionChange: function(el, records) {
        records && records.length && (this.updateButtons(records), this.fireEvent("selectdevice", records[0], !0));
    },
    ...
    constructor: function(config) {
        ...
        this.filter.setFilterFn(function(item) {
            ...
            if (Ext.isArray(property))
                for (item = 0; item < property.length; item++) {
                    if (-1 !== value.indexOf(property[item])) return !0;
                }
...
Ext.define("Traccar.view.permissions.Notifications", {
    ...
    columns: {
        items: [{
                ...
                filter: { type: "list", idField: "type", labelField: "name", store: "AllNotificationTypes" },
            },
            { text: Strings.notificationAlways, dataIndex: "always", flex: 1, minWidth: Traccar.Style.columnWidthNormal, renderer: Traccar.AttributeFormatter.getFormatter("always"), filter: "boolean" },
            {
                ...
                renderer: function(value) {
                    var result = "";
                    if (value) {
                        var notificators = value.split(/[ ,]+/).filter(Boolean);
                        for (value = 0; value < notificators.length; value++) result += Traccar.app.getNotificatorString(notificators[value]) + (value < notificators.length - 1 ? ", " : "");
                    }
                    return result;
                },
            },
...
Ext.define("Traccar.view.dialog.SelectDeviceController", {
    ...
    onSaveClick: function(button) {
        ...
        Ext.Ajax.request({
            ...
            callback: function(options, success, response) {
                success ? Ext.Msg.alert(Strings.sharedInfoTitle, response.responseText || response.statusText) : Traccar.app.showError(response);
            },
        });
        button.up("window").close();
    },
    onDeviceChange: function(combobox, newValue) {
        this.lookupReference("saveButton").setDisabled(null === newValue);
    },
});
Ext.define("Traccar.view.dialog.SelectDevice", {
    ...
    buttons: [
        { glyph: "xf00c@FontAwesome", reference: "saveButton", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, handler: "onSaveClick", disabled: !0 },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
    ],
});
Ext.define("Traccar.view.dialog.ComputedAttributeController", {
    ...
    onAttributeChange: function(combobox, newValue) {
        (combobox = Ext.getStore("PositionAttributes").getById(newValue)) ?
        (this.getView().lookupReference("typeComboField").setValue(combobox.get("valueType")), this.getView().lookupReference("typeComboField").setReadOnly(!0)) :
        this.getView().lookupReference("typeComboField").setReadOnly(!1);
    },
    onCheckClick: function(button) {
        var dialog = Ext.create("Traccar.view.dialog.SelectDevice");
        button = button.up("window").down("form");
        button.updateRecord();
...
Ext.define("Traccar.view.dialog.ComputedAttribute", {
    ...
    items: {
        xtype: "form",
        items: [
            { xtype: "unescapedTextField", name: "description", fieldLabel: Strings.sharedDescription },
            { xtype: "combobox", name: "attribute", fieldLabel: Strings.sharedAttribute, store: "PositionAttributes", displayField: "name", valueField: "key", listeners: { change: "onAttributeChange" } },
            { xtype: "unescapedTextAreaField", reference: "expressionField", name: "expression", fieldLabel: Strings.sharedExpression, allowBlank: !1 },
    ...
    buttons: [
        { glyph: "xf128@FontAwesome", tooltip: Strings.sharedCheckComputedAttribute, tooltipType: "title", minWidth: 0, handler: "onCheckClick" },
        { glyph: "xf00c@FontAwesome", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, handler: "onSaveClick" },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
    ],
});
...
Ext.define("Traccar.view.edit.ComputedAttributes", {
    ...
    columns: {
        defaults: { flex: 1, minWidth: Traccar.Style.columnWidthNormal },
        items: [
            { text: Strings.sharedDescription, dataIndex: "description", filter: "string" },
            {
                text: Strings.sharedAttribute,
                dataIndex: "attribute",
                filter: { type: "list", labelField: "name", store: "PositionAttributes" },
            ...
            { text: Strings.sharedExpression, dataIndex: "expression" },
            {
                text: Strings.sharedType,
                dataIndex: "type",
                filter: { type: "list", labelField: "name", store: "AttributeValueTypes" },
                renderer: function(value) {
...
Ext.define("Traccar.view.dialog.DeviceAccumulatorsController", {
    ...
    onSetClick: function() {
        ...
        Ext.Ajax.request({
            ...
            jsonData: Ext.util.JSON.encode(data),
            callback: function(options, success, response) {
                success || Traccar.app.showError(response);
            },
        });
        this.closeView();
    },
...
Ext.define("Traccar.view.dialog.DeviceAccumulators", {
    ...
    items: [
        { xtype: "customNumberField", dataType: "distance", reference: "totalDistance", fieldLabel: Strings.deviceTotalDistance },
        { xtype: "customNumberField", dataType: "hours", reference: "hours", fieldLabel: Strings.positionHours },
    ],
    buttons: [
        { reference: "setButton", glyph: "xf00c@FontAwesome", tooltip: Strings.sharedSet, tooltipType: "title", minWidth: 0, handler: "onSetClick" },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
    ],
});
Ext.define("Traccar.view.DeviceMenuController", {
    ...
    onGeofencesClick: function() {
        Ext.create("Traccar.view.BaseWindow", {
            ...
            items: { xtype: "linkGeofencesView", baseObjectName: "deviceId", linkObjectName: "geofenceId", storeName: "Geofences", baseObject: this.getView().up("deviceMenu").device.getId() },
        }).show();
    },
    onNotificationsClick: function() {
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedNotifications,
            items: { xtype: "linkNotificationsView", baseObjectName: "deviceId", linkObjectName: "notificationId", storeName: "Notifications", baseObject: this.getView().up("deviceMenu").device.getId() },
        }).show();
    },
    ...
    onDriversClick: function() {
        Ext.create("Traccar.view.BaseWindow", {
            ...
            items: { xtype: "linkDriversView", baseObjectName: "deviceId", linkObjectName: "driverId", storeName: "Drivers", baseObject: this.getView().up("deviceMenu").device.getId() },
        }).show();
    },
    onCommandsClick: function() {
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedSavedCommands,
            items: { xtype: "linkSavedCommandsView", baseObjectName: "deviceId", linkObjectName: "commandId", storeName: "Commands", baseObject: this.getView().up("deviceMenu").device.getId() },
        }).show();
    },
    onMaintenancesClick: function() {
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedMaintenance,
            items: { xtype: "linkMaintenancesView", baseObjectName: "deviceId", linkObjectName: "maintenanceId", storeName: "Maintenances", baseObject: this.getView().up("deviceMenu").device.getId() },
        }).show();
    },
    onDeviceAccumulatorsClick: function() {
        ...
        if ((position = Ext.getStore("LatestPositions").findRecord("deviceId", dialog.deviceId, 0, !1, !1, !0)))
            dialog.lookupReference("totalDistance").setValue(position.get("attributes").totalDistance), dialog.lookupReference("hours").setValue(position.get("attributes").hours);
        dialog.show();
    },
});
Ext.define("Traccar.view.DeviceMenu", {
    ...
    xtype: "deviceMenu",
    glyph: "f085@FontAwesome",
    tooltip: Strings.settingsTitle,
    tooltipType: "title",
    menu: {
        controller: "deviceMenu",
        items: [
            { text: Strings.sharedDrivers, glyph: "xf1e7@FontAwesome", handler: "onDriversClick", reference: "menuDriversButton" },
            { text: Strings.sharedGeofences, glyph: "xf279@FontAwesome", handler: "onGeofencesClick", reference: "menuGeofencesButton" },
            { text: Strings.sharedNotifications, glyph: "xf0f3@FontAwesome", handler: "onNotificationsClick", reference: "menuNotificationsButton" },
            { text: Strings.sharedComputedAttributes, glyph: "xf0ae@FontAwesome", handler: "onComputedAttributesClick", reference: "menuComputedAttributesButton" },
            { text: Strings.sharedSavedCommands, glyph: "xf093@FontAwesome", handler: "onCommandsClick", reference: "menuCommandsButton" },
            { text: Strings.sharedMaintenance, glyph: "xf0ad@FontAwesome", handler: "onMaintenancesClick", reference: "menuMaintenancesButton" },
            { hidden: !0, text: Strings.sharedDeviceAccumulators, glyph: "xf0e4@FontAwesome", handler: "onDeviceAccumulatorsClick", reference: "menuDeviceAccumulatorsButton" },
        ],
    },
});
Ext.define("Traccar.view.edit.Devices", {
    ...
    tbar: {
        ...
        items: [
            { xtype: 'image', src: '../../../icon.png', width: 40, height: 30 },
            { xtype: "tbtext", html: Strings.deviceTitle, baseCls: "x-panel-header-title-default" },
            { xtype: "tbfill", disabled: !1 },
            { handler: "onAddClick", reference: "toolbarAddButton", glyph: "f055@FontAwesome", tooltip: Strings.sharedAdd },
            { handler: "onEditClick", reference: "toolbarEditButton", glyph: "f044@FontAwesome", tooltip: Strings.sharedEdit },
            { handler: "onRemoveClick", reference: "toolbarRemoveButton", glyph: "f1f8@FontAwesome", tooltip: Strings.sharedRemove },
            { handler: "onCommandClick", reference: "deviceCommandButton", glyph: "f25e@FontAwesome", tooltip: Strings.deviceCommand },
            { xtype: "deviceMenu", reference: "toolbarDeviceMenu", enableToggle: !1 },
        ],
    },
    listeners: { selectionchange: "onSelectionChange" },
    viewConfig: {
    ...
    columns: {
        defaults: { flex: 1, minWidth: Traccar.Style.columnWidthNormal },
        items: [
            { text: Strings.sharedName, dataIndex: "name", filter: "string" },
            { text: Strings.deviceIdentifier, dataIndex: "uniqueId", hidden: !0, filter: "string" },
            { text: Strings.sharedPhone, dataIndex: "phone", hidden: !0 },
            { text: Strings.deviceModel, dataIndex: "model", hidden: !0 },
            { text: Strings.deviceContact, dataIndex: "contact", hidden: !0 },
            { text: Strings.groupDialog, dataIndex: "groupId", hidden: !0, filter: { type: "list", labelField: "name", store: "Groups" }, renderer: Traccar.AttributeFormatter.getFormatter("groupId") },
            { text: Strings.sharedDisabled, dataIndex: "disabled", renderer: Traccar.AttributeFormatter.getFormatter("disabled"), hidden: !0, filter: "boolean" },
            {
            ...
            },
            {
                ...
                dataIndex: "status",
                filter: { type: "list", labelField: "name", store: "DeviceStatuses" },
                renderer: function(value) {
                    return value && (value = Ext.getStore("DeviceStatuses").getById(value)) ? value.get("name") : null;
                },
            },
...
Ext.define("Traccar.view.StateController", {
    ...
    config: {
        listen: {
            controller: { "*": { selectdevice: "selectDevice", selectreport: "selectPosition", selectevent: "selectPosition", deselectfeature: "deselectFeature" } },
            global: { stategeocode: "onGeocode" },
            store: { "#LatestPositions": { add: "updateLatest", update: "updateLatest" }, "#ReportRoute": { clear: "clearReport" } },
        },
    },
    init: function() {
        (Traccar.app.getUser().get("administrator") || (!Traccar.app.getUser().get("deviceReadonly") && !Traccar.app.getPreference("readonly", !1))) &&
        this.lookupReference("computedAttributesButton").setDisabled(Traccar.app.getBooleanAttributePreference("ui.disableComputedAttributes"));
        var i = Traccar.app.getAttributePreference("ui.hidePositionAttributes");
        this.hideAttributes = {};
        if (i) {
            var attributesList = i.split(/[ ,]+/).filter(Boolean);
            for (i = 0; i < attributesList.length; i++) this.hideAttributes[attributesList[i]] = !0;
        }
    },
    onComputedAttributesClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedComputedAttributes, items: { xtype: "computedAttributesView" } }).show();
    },
    keys: (function() {
        var i;
        var result = {};
        var list = "fixTime latitude longitude valid accuracy altitude speed course address protocol".split(" ");
    ...
    updateLatest: function(store, data) {
        ...
        for (store = 0; store < data.length; store++) this.deviceId === data[store].get("deviceId") && ((this.position = data[store]), this.updatePosition());
    },
    formatValue: function(value) {
        return "number" === typeof id ? Number(value.toFixed(2)) : value;
    },
    ...
    updatePosition: function() {
        ...
        for (key in this.position.data)
            ...
            void 0 !== this.keys[key] &&
            store.add(Ext.create("Traccar.model.Attribute", { priority: this.keys[key].priority, name: this.keys[key].name, value: Traccar.AttributeFormatter.getFormatter(key)(this.position.get(key)) }));
        ...
        if (attributes instanceof Object)
            for (key in attributes)
                if (attributes.hasOwnProperty(key) && !this.hideAttributes[key]) {
                    ...
                    var value = void 0 !== this.position.get("attribute." + key) ? Traccar.AttributeFormatter.getAttributeFormatter(key)(this.position.get("attribute." + key)) : Traccar.AttributeFormatter.defaultFormatter(attributes[key]);
    ...
    selectPosition: function(position) {
        position instanceof Traccar.model.Position && ((this.deviceId = null), (this.position = position), this.updatePosition());
    },
    deselectFeature: function() {
    ...
    clearReport: function() {
        this.deviceId || ((this.position = null), Ext.getStore("Attributes").removeAll());
    },
    onGeocode: function() {
        var positionId = this.position.getId();
        this.position.get("address") ||
            Ext.Ajax.request({
                scope: this,
                method: "GET",
                ...
                success: function(response) {
                    this.position && this.position.getId() === positionId && (this.position.set("address", response.responseText), this.updatePosition());
                },
...
Ext.define("Traccar.view.State", {
    ...
    tbar: {
        ...
        items: [
            { xtype: 'image', src: '../../../icon.png', width: 40, height: 30 },
            { xtype: "tbtext", html: Strings.stateTitle, baseCls: "x-panel-header-title-default" },
            { xtype: "tbfill" },
            { xtype: "button", disabled: !0, handler: "onComputedAttributesClick", reference: "computedAttributesButton", glyph: "xf0ae@FontAwesome", tooltip: Strings.sharedComputedAttributes, tooltipType: "title" },
        ],
    },
    columns: {
        defaults: { minWidth: Traccar.Style.columnWidthNormal, flex: 1 },
        items: [
            { text: Strings.stateName, dataIndex: "name" },
            {
                text: Strings.stateValue,
                dataIndex: "value",
                cellWrap: !0,
                    ...
                    if ("alarm" === record.get("attribute")) metaData.tdCls = "view-color-red";
                        ...
                        if (record.get("name") === Strings.positionImage || record.get("name") === Strings.positionAudio)
                            if ((metaData = this.getController().position))
                                if ((metaData = Ext.getStore("Devices").getById(metaData.get("deviceId")))) return '\x3ca target\x3d"_blank" href\x3d"/api/media/' + metaData.get("uniqueId") + "/" + value + '" \x3e' + value + "\x3c/a\x3e";
                    }
                    return value;
                },
            },
...
Ext.define("Traccar.view.dialog.ReportConfigController", {
    ...
    onSaveClick: function(button) {
        ...
        var eventType = this.lookupReference("eventTypeField").getValue(); -
        1 < eventType.indexOf(Traccar.store.ReportEventTypes.allEvents) ?
...
Ext.define("Traccar.view.dialog.ReportConfig", {
    ...
    items: [
        { fieldLabel: Strings.reportDevice, xtype: "tagfield", reference: "deviceField", maxWidth: Traccar.Style.formFieldWidth, store: "Devices", valueField: "id", displayField: "name", queryMode: "local" },
        { fieldLabel: Strings.reportGroup, xtype: "tagfield", reference: "groupField", maxWidth: Traccar.Style.formFieldWidth, store: "Groups", valueField: "id", displayField: "name", queryMode: "local" },
        { fieldLabel: Strings.reportEventTypes, xtype: "tagfield", reference: "eventTypeField", maxWidth: Traccar.Style.formFieldWidth, store: "ReportEventTypes", hidden: !0, valueField: "type", displayField: "name", queryMode: "local" },
        { fieldLabel: Strings.reportChartType, xtype: "combobox", reference: "chartTypeField", store: "ReportChartTypes", hidden: !0, value: "speed", valueField: "key", displayField: "name", queryMode: "local" },
        { fieldLabel: Strings.reportShowMarkers, xtype: "checkbox", reference: "showMarkersField", inputValue: !0, uncheckedValue: !1, value: !1 },
        { fieldLabel: Strings.reportPeriod, reference: "periodField", xtype: "combobox", store: "ReportPeriods", editable: !1, valueField: "key", displayField: "name", queryMode: "local", listeners: { change: "onPeriodChange" } },
        {
            ...
            items: [
                { xtype: "datefield", reference: "fromDateField", startDay: Traccar.Style.weekStartDay, format: Traccar.Style.dateFormat, value: new Date(new Date().getTime() - 18e5) },
                { xtype: "customTimeField", reference: "fromTimeField", value: new Date(new Date().getTime() - 18e5) },
            ],
        },
        {
            xtype: "fieldcontainer",
            ...
            items: [
                { xtype: "datefield", reference: "toDateField", startDay: Traccar.Style.weekStartDay, format: Traccar.Style.dateFormat, value: new Date() },
                { xtype: "customTimeField", reference: "toTimeField", value: new Date() },
            ],
        },
    ],
    buttons: [
...
Ext.define("Traccar.view.ReportController", {
    ...
    config: {
        listen: {
            controller: { "*": { selectdevice: "deselectReport", selectevent: "deselectReport", showsingleevent: "showSingleEvent" }, map: { selectreport: "selectReport", deselectfeature: "deselectFeature" } },
            global: { routegeocode: "onGeocode" },
            store: { "#ReportEvents": { add: "loadRelatedPositions", load: "loadRelatedPositions" }, "#ReportRoute": { load: "loadRoute" }, "#ReportStops": { load: "loadRelatedPositions" } },
        },
    },
    hideReports: function() {
        Traccar.app.showReports(!1);
    },
    getGrid: function() {
    ...
    init: function() {
        ...
        if (Traccar.app.getVehicleFeaturesDisabled()) {
            for (i = 0; i < this.summaryColumns.length; i++) this.summaryColumns[i].dataIndex.match("engineHours|spentFuel") && (this.summaryColumns[i].hidden = !0);
    ...
    onConfigureClick: function() {
        ...
        dialog.lookupReference("eventTypeField").setHidden("events" !== this.lookupReference("reportTypeField").getValue());
        ...
        void 0 !== this.chartType && dialog.lookupReference("chartTypeField").setValue(this.chartType);
    ...
    updateButtons: function() {
        ...
        this.lookupReference("exportButton").setDisabled("chart" === reportType || disabled);
    ...
    onReportClick: function(button) {
        ...
        if ((reportType = this.lookupReference("reportTypeField").getValue()) && (this.deviceId || this.groupId)) {
            ...
            this.updateButtons();
            "showButton" === button.reference ?
                ("chart" === reportType ? ((button = this.getChart().getStore()), this.getChart().setSeries([])) : (button = this.getGrid().getStore()),
                    (button.showMarkers = this.showMarkers),
                    button.load({
                        scope: this,
                        callback: function() {
                ...
                ((reportType = this.getGrid().getStore().getProxy().url),
                    this.excelReport(reportType, { deviceId: this.deviceId, groupId: this.groupId, type: this.eventType, from: Ext.Date.format(from, "c"), to: Ext.Date.format(to, "c"), mail: "emailButton" === button.reference }));
        }
    },
    ...
    onSelectionChange: function(selection, selected) {
        0 < selected.length &&
            ((selection = selected[0]),
                this.fireEvent("selectreport", selection, !0),
                selection instanceof Traccar.model.ReportTrip && this.selectTrip(selection),
                (selection instanceof Traccar.model.Event || selection instanceof Traccar.model.ReportStop) && this.selectPositionRelated(selection));
    },
    selectReport: function(object) {
        ...
        if (object instanceof Traccar.model.Position)
            ...
            else if ("events" === reportType || "stops" === reportType)
            (object = this.getGrid().getStore().findRecord("positionId", object.get("id"), 0, !1, !0, !0)), this.getGrid().getSelectionModel().select([object], !1, !0), this.getGrid().getView().focusRow(object);
    },
    deselectReport: function(object) {
        object && this.deselectFeature();
    },
    deselectFeature: function() {
        "trips" !== this.lookupReference("reportTypeField").getValue() && this.getGrid().getSelectionModel().deselectAll();
    },
    ...
    selectPositionRelated: function(report) {
        report.get("positionId") && (report = Ext.getStore("ReportRoute").getById(report.get("positionId"))) && this.fireEvent("selectreport", report, !0);
    },
    loadRelatedPositions: function(store, data) {
        ...
        0 < positionIds.length &&
            Ext.getStore("Positions").load({
                ...
                scope: this,
                callback: function(records, operation, success) {
                    success && ((Ext.getStore("ReportRoute").showMarkers = this.showMarkers), Ext.getStore("ReportRoute").add(records), 1 === records.length && this.fireEvent("selectreport", records[0], !1));
                },
            });
    },
    ...
    onChartMarkerClick: function(chart, item) {
        this.fireEvent("selectreport", item.record, !0);
    },
            ...
            callback: function(records, operation, success) {
                success &&
                    (Ext.getStore("ReportEvents").add(records),
                        0 < records.length &&
                        (records[0].get("positionId") || (Traccar.app.isMobile() ? Traccar.app.showReports(!0) : this.getView().expand()),
                            this.getGrid().getSelectionModel().select([records[0]], !1, !0),
        ...
        Ext.Ajax.request({
            ...
            callback: function(options, success, response) {
                if (success && !requestParams.mail)
                    if (
                        ((options = response.getResponseHeader("Content-Disposition")),
                            (options = options.slice(options.indexOf("\x3d") + 1, options.length)),
                            (success = response.getResponseHeader("Content-Type")),
                            (response = new Blob([response.responseBytes], { type: success })),
                            "undefined" !== typeof window.navigator.msSaveBlob)
                    )
                        window.navigator.msSaveBlob(response, options);
                    else {
    ...
    onTypeChange: function(combobox, newValue, oldValue) {
        ...
        "route" === newValue
            ?
            (this.getGrid().reconfigure("ReportRoute", this.routeColumns), this.getView().getLayout().setActiveItem("grid")) :
            "events" === newValue ?
            (this.getGrid().reconfigure("ReportEvents", this.eventsColumns), this.getView().getLayout().setActiveItem("grid")) :
            "summary" === newValue ?
            (this.getGrid().reconfigure("ReportSummary", this.summaryColumns), this.getView().getLayout().setActiveItem("grid")) :
            "trips" === newValue ?
            (this.getGrid().reconfigure("ReportTrips", this.tripsColumns), this.getView().getLayout().setActiveItem("grid")) :
            "stops" === newValue ?
            (this.getGrid().reconfigure("ReportStops", this.stopsColumns), this.getView().getLayout().setActiveItem("grid")) :
            "chart" === newValue && this.getView().getLayout().setActiveItem("chart");
        this.updateButtons();
    },
    onGeocode: function(positionId) {
        ...
        position &&
            ...
            Ext.Ajax.request({
                ...
                method: "GET",
                url: "api/server/geocode",
                params: { latitude: position.get("latitude"), longitude: position.get("longitude") },
                success: function(response) {
    ...
    routeColumns: [
        { text: Strings.reportDeviceName, dataIndex: "deviceId", renderer: Traccar.AttributeFormatter.getFormatter("deviceId") },
        { text: Strings.positionValid, dataIndex: "valid", renderer: Traccar.AttributeFormatter.getFormatter("valid") },
        { text: Strings.positionFixTime, dataIndex: "fixTime", xtype: "datecolumn", renderer: Traccar.AttributeFormatter.getFormatter("fixTime") },
        { text: Strings.positionLatitude, dataIndex: "latitude", renderer: Traccar.AttributeFormatter.getFormatter("latitude") },
        { text: Strings.positionLongitude, dataIndex: "longitude", renderer: Traccar.AttributeFormatter.getFormatter("longitude") },
        { text: Strings.positionAltitude, dataIndex: "altitude", renderer: Traccar.AttributeFormatter.getFormatter("altitude") },
        { text: Strings.positionSpeed, dataIndex: "speed", renderer: Traccar.AttributeFormatter.getFormatter("speed") },
        {
            text: Strings.positionAddress,
            dataIndex: "address",
            renderer: function(value, metaData, record) {
                return value ? Traccar.AttributeFormatter.getFormatter("address")(value) : '\x3ca href\x3d"#" onclick\x3d"Ext.fireEvent(\'routegeocode\', ' + record.getId() + ')" \x3e' + Strings.sharedShowAddress + "\x3c/a\x3e";
            },
        },
    ],
    eventsColumns: [
        { text: Strings.positionFixTime, dataIndex: "serverTime", xtype: "datecolumn", renderer: Traccar.AttributeFormatter.getFormatter("serverTime") },
        { text: Strings.reportDeviceName, dataIndex: "deviceId", renderer: Traccar.AttributeFormatter.getFormatter("deviceId") },
        {
            text: Strings.sharedType,
            dataIndex: "type",
        ...
        { text: Strings.sharedGeofence, dataIndex: "geofenceId", renderer: Traccar.AttributeFormatter.getFormatter("geofenceId") },
        { text: Strings.sharedMaintenance, dataIndex: "maintenanceId", renderer: Traccar.AttributeFormatter.getFormatter("maintenanceId") },
    ],
    summaryColumns: [
        { text: Strings.reportDeviceName, dataIndex: "deviceId", renderer: Traccar.AttributeFormatter.getFormatter("deviceId") },
        { text: Strings.sharedDistance, dataIndex: "distance", renderer: Traccar.AttributeFormatter.getFormatter("distance") },
        { text: Strings.reportStartOdometer, dataIndex: "startOdometer", renderer: Traccar.AttributeFormatter.getFormatter("distance") },
        { text: Strings.reportEndOdometer, dataIndex: "endOdometer", renderer: Traccar.AttributeFormatter.getFormatter("distance") },
        { text: Strings.reportAverageSpeed, dataIndex: "averageSpeed", renderer: Traccar.AttributeFormatter.getFormatter("speed") },
        { text: Strings.reportMaximumSpeed, dataIndex: "maxSpeed", renderer: Traccar.AttributeFormatter.getFormatter("speed") },
        { text: Strings.reportEngineHours, dataIndex: "engineHours", renderer: Traccar.AttributeFormatter.getFormatter("duration") },
        { text: Strings.reportSpentFuel, dataIndex: "spentFuel", renderer: Traccar.AttributeFormatter.getFormatter("spentFuel") },
    ],
    tripsColumns: [
        { text: Strings.reportDeviceName, dataIndex: "deviceId", renderer: Traccar.AttributeFormatter.getFormatter("deviceId") },
        { text: Strings.reportStartTime, dataIndex: "startTime", xtype: "datecolumn", renderer: Traccar.AttributeFormatter.getFormatter("startTime") },
        { text: Strings.reportStartOdometer, dataIndex: "startOdometer", renderer: Traccar.AttributeFormatter.getFormatter("distance") },
        { text: Strings.reportStartAddress, dataIndex: "startAddress", renderer: Traccar.AttributeFormatter.getFormatter("address") },
        { text: Strings.reportEndTime, dataIndex: "endTime", xtype: "datecolumn", renderer: Traccar.AttributeFormatter.getFormatter("endTime") },
        { text: Strings.reportEndOdometer, dataIndex: "endOdometer", renderer: Traccar.AttributeFormatter.getFormatter("distance") },
        { text: Strings.reportEndAddress, dataIndex: "endAddress", renderer: Traccar.AttributeFormatter.getFormatter("address") },
        { text: Strings.sharedDistance, dataIndex: "distance", renderer: Traccar.AttributeFormatter.getFormatter("distance") },
        { text: Strings.reportAverageSpeed, dataIndex: "averageSpeed", renderer: Traccar.AttributeFormatter.getFormatter("speed") },
        { text: Strings.reportMaximumSpeed, dataIndex: "maxSpeed", renderer: Traccar.AttributeFormatter.getFormatter("speed") },
        { text: Strings.reportDuration, dataIndex: "duration", renderer: Traccar.AttributeFormatter.getFormatter("duration") },
        { text: Strings.reportSpentFuel, dataIndex: "spentFuel", renderer: Traccar.AttributeFormatter.getFormatter("spentFuel") },
        { text: Strings.sharedDriver, dataIndex: "driverUniqueId", renderer: Traccar.AttributeFormatter.getFormatter("driverUniqueId") },
    ],
    stopsColumns: [
        { text: Strings.reportDeviceName, dataIndex: "deviceId", renderer: Traccar.AttributeFormatter.getFormatter("deviceId") },
        { text: Strings.reportStartTime, dataIndex: "startTime", xtype: "datecolumn", renderer: Traccar.AttributeFormatter.getFormatter("startTime") },
        { text: Strings.positionOdometer, dataIndex: "startOdometer", renderer: Traccar.AttributeFormatter.getFormatter("distance") },
        { text: Strings.positionAddress, dataIndex: "address", renderer: Traccar.AttributeFormatter.getFormatter("address") },
        { text: Strings.reportEndTime, dataIndex: "endTime", xtype: "datecolumn", renderer: Traccar.AttributeFormatter.getFormatter("endTime") },
        { text: Strings.reportDuration, dataIndex: "duration", renderer: Traccar.AttributeFormatter.getFormatter("duration") },
        { text: Strings.reportEngineHours, dataIndex: "engineHours", renderer: Traccar.AttributeFormatter.getFormatter("duration") },
        { text: Strings.reportSpentFuel, dataIndex: "spentFuel", renderer: Traccar.AttributeFormatter.getFormatter("spentFuel") },
...
Ext.define("Traccar.view.Report", {
    ...
    tbar: {
        ...
        items: [
            { xtype: 'image', src: '../../../icon.png', width: 40, height: 30 },
            { xtype: "tbtext", html: Strings.sharedType },
            { xtype: "combobox", reference: "reportTypeField", store: "ReportTypes", displayField: "name", valueField: "key", editable: !1, listeners: { change: "onTypeChange" } },
            "-",
            { text: Strings.reportConfigure, handler: "onConfigureClick" },
            "-",
            { text: Strings.reportShow, reference: "showButton", disabled: !0, handler: "onReportClick" },
            { text: Strings.reportExport, reference: "exportButton", disabled: !0, handler: "onReportClick" },
            { text: Strings.reportEmail, reference: "emailButton", disabled: !0, handler: "onReportClick" },
            { text: Strings.reportClear, handler: "onClearClick" },
        ],
    },
    layout: "card",
    items: [
        { xtype: "customGridPanel", itemId: "grid", listeners: { selectionchange: "onSelectionChange" }, columns: { defaults: { flex: 1, minWidth: Traccar.Style.columnWidthNormal }, items: [] }, style: Traccar.Style.reportGridStyle },
        {
            xtype: "cartesian",
            itemId: "chart",
            plugins: { ptype: "chartitemevents", moveEvents: !0 },
            store: "ReportRoute",
            axes: [
                { title: Strings.reportChart, type: "numeric", position: "left" },
                { type: "time", position: "bottom", fields: ["fixTime"] },
            ],
            listeners: { itemclick: "onChartMarkerClick" },
...
Ext.define("Traccar.view.EventsController", {
    ...
    onRemoveClick: function() {
        var event;
        if ((event = this.getView().getSelectionModel().getSelection()[0]))
            Ext.getStore("Events").remove(event),
            (event = event.get("positionId")) && !Ext.getStore("Events").findRecord("positionId", event, 0, !1, !1, !0) && Ext.getStore("EventPositions").remove(Ext.getStore("EventPositions").getById(event));
    },
    onClearClick: function() {
    ...
    onScrollToLastClick: function(button, pressed) {
        if (pressed) this.onAddEvent();
    },
    onHideEvents: function() {
        Traccar.app.showEvents(!1);
    },
    ...
    onSelectionChange: function(selection, selected) {
        var position;
        if ((selection = 0 < selected.length ? selected[0] : null))
            (selected = selection.get("positionId")) ?
            (position = Ext.getStore("EventPositions").getById(selected)) ?
            ...
            Ext.getStore("EventPositions").load({
                ...
                addRecords: !0,
                callback: function(records, operation, success) {
                    success && 0 < records.length && this.fireEvent("selectevent", records[0]);
                },
            }) :
...
Ext.define("Traccar.view.Events", {
    ...
    tbar: {
        ...
        items: [
            { xtype: 'image', src: '../../../icon.png', width: 40, height: 30 },
            { xtype: "tbtext", html: Strings.reportEvents, baseCls: "x-panel-header-title-default" },
            { xtype: "tbfill" },
            { glyph: "xf063@FontAwesome", pressed: !0, toggleHandler: "onScrollToLastClick", stateId: "events-scroll-to-last-button", tooltip: Strings.eventsScrollToLast, reference: "scrollToLastButton" },
            { id: "soundButton", glyph: "xf0a2@FontAwesome", tooltip: Strings.sharedSound, stateId: "sound-button" },
            { glyph: "xf014@FontAwesome", tooltip: Strings.sharedRemove, handler: "onRemoveClick", reference: "removeEventButton", disabled: !0, stateful: !1, enableToggle: !1 },
            { glyph: "xf1f8@FontAwesome", tooltip: Strings.reportClear, handler: "onClearClick", stateful: !1, enableToggle: !1 },
            { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedHide, handler: "onHideEvents", reference: "hideEventsButton", hidden: !0, stateful: !1, enableToggle: !1 },
        ],
    },
    listeners: { selectionchange: "onSelectionChange" },
    columns: {
        defaults: { flex: 1, minWidth: Traccar.Style.columnWidthNormal },
        items: [
            { text: Strings.sharedDevice, dataIndex: "deviceId", renderer: Traccar.AttributeFormatter.getFormatter("deviceId") },
            { flex: 2, text: Strings.positionEvent, dataIndex: "text" },
            { text: Strings.positionFixTime, dataIndex: "serverTime", renderer: Traccar.AttributeFormatter.getFormatter("lastUpdate") },
        ],
    },
});
Ext.define(
    "Traccar.view.map.BaseMap", {
        extend: Ext.panel.Panel,
        xtype: "baseMapView",
        layout: "fit",
        getMap: function() {
        ...
        initMap: function() {
            ...
            switch (type) {
                case "custom":
                    ...
                    break;
                case "customArcgis":
                    server = new ol.layer.Tile({ source: new ol.source.TileArcGISRest({ url: Ext.String.htmlDecode(server.get("mapUrl")) }) });
                    break;
                case "bingRoad":
                ...
                case "carto":
                    server = new ol.layer.Tile({
                        source: new ol.source.XYZ({
                            ...
                            attributions: '\x26copy; \x3ca href\x3d"http://www.openstreetmap.org/copyright"\x3eOpenStreetMap\x3c/a\x3e contributors, \x26copy; \x3ca href\x3d"https://carto.com/attributions"\x3eCARTO\x3c/a\x3e',
                        }),
                    });
                    break;
                case "baidu":
                    server = new ol.layer.Tile({
                        source: new ol.source.XYZ({
                            ...
                            tileUrlFunction: function(tileCoord) {
                                ...
                                return "https://online{}.map.bdimg.com/onlinelabel/?qt\x3dtile\x26x\x3d{x}\x26y\x3d{y}\x26z\x3d{z}\x26styles\x3dpl"
                                    .replace("{}", 0 > index ? index + 5 : index)
                                    .replace("{x}", x)
                                    .replace("{y}", tileCoord)
                                    .replace("{z}", z);
                            },
                ...
                case "yandexSat":
                    server = new ol.layer.Tile({
                        source: new ol.source.XYZ({
                            url: "https://sat0{1-4}.maps.yandex.net/tiles?l\x3dsat\x26x\x3d{x}\x26y\x3d{y}\x26z\x3d{z}",
                            projection: "EPSG:3395",
                            attributions: '\x26copy; \x3ca href\x3d"https://yandex.com/maps/"\x3eYandex\x3c/a\x3e',
                        }),
                    });
                ...
                case "wikimedia":
                    ...
                    break;
                default:
                    server = new ol.layer.Tile({ source: new ol.source.OSM({}) });
            }
            ...
            this.map = new ol.Map({ target: this.body.dom.id, layers: [server], view: this.mapView });
...
Ext.define("Traccar.DeviceImages", {
    ...
    getImageSvg: function(color, zoom, angle, category) {
        ...
        for (i = 0; i < fill.length; i++) svg.getElementById(fill[i]).style.fill = color;
        color = "rotate(" + angle + " " + width / 2 + " " + height / 2 + ")";
        svg.getElementById(category.get("rotateId")).setAttribute("transform", color);
        zoom
            ?
            ((width *= Traccar.Style.mapScaleSelected), (height *= Traccar.Style.mapScaleSelected), (zoom = "scale(" + Traccar.Style.mapScaleSelected + ") ")) :
            ((width *= Traccar.Style.mapScaleNormal), (height *= Traccar.Style.mapScaleNormal), (zoom = "scale(" + Traccar.Style.mapScaleNormal + ") "));
        category.get("scaleId") !== category.get("rotateId") ? svg.getElementById(category.get("scaleId")).setAttribute("transform", zoom) : svg.getElementById(category.get("scaleId")).setAttribute("transform", zoom + " " + color);
    ...
    formatSrc: function(svg) {
        return "data:image/svg+xml;charset\x3dutf-8," + encodeURIComponent(new XMLSerializer().serializeToString(svg.documentElement));
    },
    cloneDocument: function(svgDocument) {
        var newDocument = svgDocument.implementation.createDocument(svgDocument.namespaceURI, null, null);
...
Ext.define("Traccar.view.map.MapMarkerController", {
    ...
    config: {
        listen: {
            ...
            store: {
                ...
                "#LatestPositions": { add: "updateLatest", update: "updateLatest" },
    ...
    getAreaStyle: function(label, color) {
        ...
        label &&
            (fillColor.text = new ol.style.Text({
                text: label,
                overflow: !0,
    ...
    updateDevice: function(store, data) {
        ...
        for (store = 0; store < data.length; store++) {
            ...
            if (deviceId in this.latestMarkers) {
                deviceId = this.latestMarkers[deviceId];
    ...
    removeDevice: function(store, data) {
        ...
        for (store = 0; store < data.length; store++) {
            ...
            this.liveRoutes[deviceId] && (markersSource.getFeatureById(this.liveRoutes[deviceId].getId()) && markersSource.removeFeature(this.liveRoutes[deviceId]), delete this.liveRoutes[deviceId]);
        }
    },
    animateMarker: function(marker$jscomp$0, geometry, course) {
        ...
        var updatePosition = function(position, marker) {
            var coordinate = marker.get("line").getCoordinateAt(position / (duration / timeout));
            ...
            position < duration / timeout ?
                ...
                (style.getImage().angle !== marker.get("nextCourse") && self.rotateMarker(style, marker.get("nextCourse")), marker.set("animating", !1));
        };
    ...
    updateLatest: function(store, data) {
        ...
        for (store = 0; store < data.length; store++) {
            ...
            if ((device = deviceStore.getById(position.get("deviceId")))) this.updateAccuracy(position, device), this.updateLatestMarker(position, device), this.updateLiveRoute(position, device);
        }
    },
    updateAccuracy: function(position, device) {
        var feature = this.accuracyCircles[position.get("deviceId")];
        if (position.get("accuracy")) {
            var center = ol.proj.fromLonLat([position.get("longitude"), position.get("latitude")]);
            ...
            feature
                ?
                (feature.getGeometry().setCenter(center), feature.getGeometry().setRadius(radius)) :
                ((feature = new ol.Feature(new ol.geom.Circle(center, radius))),
                    ...
                    this.isDeviceVisible(device) && this.getView().getAccuracySource().addFeature(feature));
    ...
    updateLatestMarker: function(position, device) {
        ...
        if (deviceId in this.latestMarkers) {
            ...
            (position = this.getLatestMarker(this.getDeviceColor(device), position.get("course"), device.get("category"))),
            position.getText().setText(Ext.String.htmlDecode(device.get("name"))),
            marker.setStyle(position),
            marker.setId(device.get("id")),
            (this.latestMarkers[deviceId] = marker),
            this.isDeviceVisible(device) && this.getView().getMarkersSource().addFeature(marker);
        marker === this.selectedMarker && this.lookupReference("deviceFollowButton").pressed && this.getView().getMapView().setCenter(marker.getGeometry().getCoordinates());
    },
    updateLiveRoute: function(position, device) {
        ...
        if (deviceId in this.liveRoutes) {
            ...
            if (lastLiveCoordinates[0] !== position[0] || lastLiveCoordinates[1] !== position[1])
                device.length >= this.liveRouteLength && device.shift(), device.push(position), this.liveRoutes[deviceId].getGeometry().setCoordinates(device);
        } else
            (position = new ol.Feature({ geometry: new ol.geom.LineString([ol.proj.fromLonLat([position.get("longitude"), position.get("latitude")])]) })),
            position.setStyle(this.getRouteStyle(deviceId)),
            position.setId(deviceId),
            (this.liveRoutes[deviceId] = position),
            this.isDeviceVisible(device) && this.getView().getMarkersSource().addFeature(position);
    },
    loadReport: function(store, data) {
        if (data) {
            ...
            for (store = 0; store < data.length; store++) {
                var position = data[store];
                position = ol.proj.fromLonLat([position.get("longitude"), position.get("latitude")]);
                if (0 === store || data[store].get("deviceId") !== data[store - 1].get("deviceId"))
                    this.reportRoute.push(new ol.Feature({ geometry: new ol.geom.LineString([]) })),
                    this.reportRoute[this.reportRoute.length - 1].setStyle(this.getRouteStyle(data[store].get("deviceId"))),
    ...
    clearReport: function() {
        ...
        if (this.reportMarkers) {
            ...
            for (key in this.reportMarkers) this.reportMarkers.hasOwnProperty(key) && i.removeFeature(this.reportMarkers[key]);
            this.reportMarkers = {};
        }
    ...
    clearEvent: function() {
        this.selectedMarker && this.selectedMarker.get("event") && this.selectMarker(null, !1);
    },
    getRouteStyle: function(deviceId) {
        return new ol.style.Style({ stroke: new ol.style.Stroke({ color: Traccar.app.getReportColor(deviceId), width: Traccar.Style.mapRouteWidth }) });
    },
    getMarkerStyle: function(zoom, color, angle, category) {
        zoom = Traccar.DeviceImages.getImageIcon(color, zoom, angle, category);
        return new ol.style.Style({
            image: zoom,
            text: new ol.style.Text({
                textBaseline: "bottom",
                fill: new ol.style.Fill({ color: Traccar.Style.mapTextColor }),
                stroke: new ol.style.Stroke({ color: Traccar.Style.mapTextStrokeColor, width: Traccar.Style.mapTextStrokeWidth }),
                offsetY: -zoom.getSize()[1] / 2 - Traccar.Style.mapTextOffset,
                font: Traccar.Style.mapTextFont,
            }),
        });
    },
    getLatestMarker: function(color, angle, category) {
        return this.getMarkerStyle(!1, color, angle, category);
    },
    getReportMarker: function(deviceId, angle) {
        return this.getMarkerStyle(!1, Traccar.app.getReportColor(deviceId), angle, "arrow");
    },
    ...
    selectMarker: function(marker, center) {
        this.selectedMarker &&
            (this.selectedMarker.get("event") ?
                ...
                !Ext.getStore("ReportRoute").showMarkers && this.selectedMarker.get("record") instanceof Traccar.model.Position ?
                (this.getView().getMarkersSource().removeFeature(this.selectedMarker), delete this.reportMarkers[this.selectedMarker.get("record").get("id")]) :
                (this.resizeMarker(this.selectedMarker.getStyle(), !1), this.selectedMarker.getStyle().setZIndex(0), this.selectedMarker.changed()));
        marker &&
            (this.resizeMarker(marker.getStyle(), !0),
                marker.getStyle().setZIndex(1),
                marker.changed(),
                center && (this.getView().getMapView().setCenter(marker.getGeometry().getCoordinates()), 0 !== this.selectZoom && this.selectZoom > this.getView().getMapView().getZoom() && this.getView().getMapView().setZoom(this.selectZoom)));
    ...
    comentado 
        var filterPanel = Ext.create('Ext.panel.Panel', {
            ...
            onBeforeDeselect: close,
            title: 'Detalles del vehículo de: ' + device.get('name') ,
            draggable: true,
            bodyStyle: 'padding: 10px; border-radius : 0px 0px 20px 20px;',
            floating: true,
            closable: true,
            cls: 'myClsDevice',
            items: [{
                ...
                name: 'UBICACION',
                value: device.get('latitude') + " " + device.get('longitude')
            },{
                xtype: 'displayfield',
            ...
            listeners: {
                render: function (c) { c.body.on('click', function () { filterPanel.hide(); filterPanel.hidden = true; }); }
            },
    ...
    selectReport: function(position, center) {
        position instanceof Traccar.model.Position ?
            (Ext.getStore("ReportRoute").showMarkers || (this.reportMarkers[position.get("id")] = this.addReportMarker(position)), this.selectMarker(this.reportMarkers[position.get("id")], center)) :
            this.selectedMarker && this.selectMarker(null, !1);
    },
    selectEvent: function(position) {
        position ? ((position = this.addReportMarker(position)), position.set("event", !0), this.selectMarker(position, !0)) : this.selectedMarker && this.selectedMarker.get("event") && this.selectMarker(null, !1);
    },
    ...
    deselectDevice: function() {
        this.selectMarker(null, !1);
        this.filterPanel.hidden();
    },
    zoomToAllPositions: function(data) {
        var i, maxx, maxy;
        for (i = 0; i < data.length; i++) {
            var point = ol.proj.fromLonLat([data[i].get("longitude"), data[i].get("latitude")]);
            if (0 === i) {
                var minx = (maxx = point[0]);
                var miny = (maxy = point[1]);
            } else(minx = Math.min(point[0], minx)), (miny = Math.min(point[1], miny)), (maxx = Math.max(point[0], maxx)), (maxy = Math.max(point[1], maxy));
        }
        minx !== maxx || miny !== maxy ? this.getView().getMapView().fit([minx, miny, maxx, maxy]) : point && this.getView().getMapView().fit(new ol.geom.Point(point));
    },
    ...
    updateDeviceVisibility: function(device) {
        ...
        this.isDeviceVisible(device) ?
            (marker && !this.getView().getMarkersSource().getFeatureById(marker.getId()) && this.getView().getMarkersSource().addFeature(marker),
                accuracy && !this.getView().getAccuracySource().getFeatureById(accuracy.getId()) && this.getView().getAccuracySource().addFeature(accuracy),
                deviceId && !this.getView().getLiveRouteSource().getFeatureById(deviceId.getId()) && this.getView().getLiveRouteSource().addFeature(deviceId)) :
            (marker && this.getView().getMarkersSource().getFeatureById(marker.getId()) && this.getView().getMarkersSource().removeFeature(marker),
                accuracy && this.getView().getAccuracySource().getFeatureById(accuracy.getId()) && this.getView().getAccuracySource().removeFeature(accuracy),
                deviceId && this.getView().getLiveRouteSource().getFeatureById(deviceId.getId()) && this.getView().getLiveRouteSource().removeFeature(deviceId));
    },
    filterDevices: function() {
        Ext.getStore("Devices").each(this.updateDeviceVisibility, this, !1);
    },
});
Ext.define("Traccar.GeofenceConverter", {
    ...
    wktToGeometry: function(mapView, wkt) {
        ...
        } else if (0 === wkt.lastIndexOf("CIRCLE", 0))
            (wkt = wkt.match(/\([^()]+\)/)),
            null !== wkt &&
            ((wkt = wkt[0].match(/-?\d+\.?\d*/g)),
                null !== wkt &&
                ((geometry = mapView.getProjection()),
                    (points = ol.proj.transform([Number(wkt[1]), Number(wkt[0])], "EPSG:4326", geometry)),
                    (mapView = mapView.getResolution()),
                    (geometry = ol.proj.getPointResolution(geometry, mapView, points)),
                    (wkt = (Number(wkt[2]) / ol.proj.Units.METERS_PER_UNIT.m) * (mapView / geometry)),
                    (geometry = new ol.geom.Circle(points, wkt))));
        else if (0 === wkt.lastIndexOf("LINESTRING", 0) && ((wkt = wkt.match(/\([^()]+\)/)), null !== wkt && ((wkt = wkt[0].match(/-?\d+\.?\d*/g)), null !== wkt))) {
            geometry = mapView.getProjection();
...
Ext.define("Traccar.view.map.MapController", {
    ...
    config: {
        listen: {
            controller: { "*": { mapstaterequest: "getMapState", zoomtoalldevices: "zoomToAllDevices" } },
            store: { "#Geofences": { load: "updateGeofences", add: "updateGeofences", update: "updateGeofences", remove: "updateGeofences" } },
        },
    },
    init: function() {
        this.callParent();
    ...
    showReports: function() {
        Traccar.app.showReports(!0);
    },
    showEvents: function() {
        Traccar.app.showEvents(!0);
    },
    ...
    getMapState: function() {
        var zoom = this.getView().getMapView().getProjection();
    ...
    updateGeofences: function() {
        ...
        this.lookupReference("showGeofencesButton").pressed &&
...
Ext.define("Traccar.view.dialog.UserController", {
    ...
    init: function() {
        ...
        if (Traccar.app.getUser().get("administrator") || !this.getView().selfEdit)
            this.lookupReference("readonlyField").setDisabled(!1),
            this.lookupReference("disabledField").setDisabled(!1),
            this.lookupReference("expirationTimeField").setDisabled(!1),
            this.lookupReference("deviceReadonlyField").setDisabled(!1),
            this.lookupReference("limitCommandsField").setDisabled(!1);
    },
...
Ext.define("Traccar.view.dialog.User", {
    ...
    items: {
        ...
        items: [{
                ...
                title: Strings.sharedRequired,
                items: [
                    { xtype: "unescapedTextField", name: "name", fieldLabel: Strings.sharedName },
                    { xtype: "unescapedTextField", name: "email", fieldLabel: Strings.userEmail, allowBlank: !1 },
                    { xtype: "textfield", name: "password", fieldLabel: Strings.userPassword, inputType: "password", allowBlank: !1 },
                ],
            },
            {
                ...
                items: [
                    { xtype: "unescapedTextField", name: "phone", fieldLabel: Strings.sharedPhone },
                    { xtype: "clearableComboBox", name: "map", fieldLabel: Strings.mapLayer, store: "MapTypes", displayField: "name", valueField: "key" },
                    { xtype: "numberfield", reference: "latitude", name: "latitude", fieldLabel: Strings.positionLatitude, decimalPrecision: Traccar.Style.coordinatePrecision },
                    { xtype: "numberfield", reference: "longitude", name: "longitude", fieldLabel: Strings.positionLongitude, decimalPrecision: Traccar.Style.coordinatePrecision },
                    { xtype: "numberfield", reference: "zoom", name: "zoom", fieldLabel: Strings.serverZoom },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "twelveHourFormat", fieldLabel: Strings.settingsTwelveHourFormat },
                    { xtype: "clearableComboBox", name: "coordinateFormat", fieldLabel: Strings.settingsCoordinateFormat, store: "CoordinateFormats", displayField: "name", valueField: "key" },
                    { xtype: "unescapedTextField", name: "poiLayer", fieldLabel: Strings.mapPoiLayer },
                ],
            },
            {
                xtype: "fieldset",
                ...
                collapsed: !0,
                items: [
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "disabled", fieldLabel: Strings.sharedDisabled, disabled: !0, reference: "disabledField" },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "administrator", fieldLabel: Strings.userAdmin, disabled: !0, reference: "adminField" },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "readonly", fieldLabel: Strings.serverReadonly, disabled: !0, reference: "readonlyField" },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "deviceReadonly", fieldLabel: Strings.userDeviceReadonly, disabled: !0, reference: "deviceReadonlyField" },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "limitCommands", fieldLabel: Strings.userLimitCommands, disabled: !0, reference: "limitCommandsField" },
                    { xtype: "datefield", name: "expirationTime", fieldLabel: Strings.userExpirationTime, disabled: !0, reference: "expirationTimeField", startDay: Traccar.Style.weekStartDay, format: Traccar.Style.dateFormat },
                    { xtype: "numberfield", name: "deviceLimit", fieldLabel: Strings.userDeviceLimit, disabled: !0, reference: "deviceLimitField" },
                    { xtype: "numberfield", name: "userLimit", fieldLabel: Strings.userUserLimit, disabled: !0, reference: "userLimitField" },
                    { xtype: "unescapedTextField", name: "token", reference: "tokenField", fieldLabel: Strings.userToken, triggers: { generate: { cls: "iconCls: x-fa fa-refresh", handler: "generateToken" } } },
                ],
            },
        ],
    },
    buttons: [
        ...
        { glyph: "xf003@FontAwesome", minWidth: 0, handler: "testNotification", hidden: !0, reference: "testNotificationButton", tooltip: Strings.sharedTestNotification, tooltipType: "title" },
        { xtype: "tbfill" },
        { glyph: "xf00c@FontAwesome", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, handler: "onSaveClick" },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
    ],
...
Ext.define("Traccar.view.dialog.Server", {
    ...
    items: {
        ...
        items: [{
                ...
                items: [
                    { xtype: "clearableComboBox", name: "map", fieldLabel: Strings.mapLayer, store: "MapTypes", displayField: "name", valueField: "key" },
                    { xtype: "unescapedTextField", name: "bingKey", fieldLabel: Strings.mapBingKey },
                    { xtype: "unescapedTextField", reference: "mapUrlField", name: "mapUrl", fieldLabel: Strings.mapCustomLabel },
                    { xtype: "numberfield", reference: "latitude", name: "latitude", fieldLabel: Strings.positionLatitude, decimalPrecision: Traccar.Style.coordinatePrecision },
                    { xtype: "numberfield", reference: "longitude", name: "longitude", fieldLabel: Strings.positionLongitude, decimalPrecision: Traccar.Style.coordinatePrecision },
                    { xtype: "numberfield", reference: "zoom", name: "zoom", fieldLabel: Strings.serverZoom },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "twelveHourFormat", fieldLabel: Strings.settingsTwelveHourFormat },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "forceSettings", fieldLabel: Strings.serverForceSettings },
                    { xtype: "clearableComboBox", name: "coordinateFormat", fieldLabel: Strings.settingsCoordinateFormat, store: "CoordinateFormats", displayField: "name", valueField: "key" },
                    { xtype: "unescapedTextField", name: "poiLayer", fieldLabel: Strings.mapPoiLayer },
                ],
            },
            {
                ...
                collapsed: !0,
                items: [
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "registration", fieldLabel: Strings.serverRegistration },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "readonly", fieldLabel: Strings.serverReadonly },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "deviceReadonly", fieldLabel: Strings.userDeviceReadonly },
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "limitCommands", fieldLabel: Strings.userLimitCommands },
                ],
            },
        ],
    },
...
Ext.define("Traccar.view.permissions.Devices", {
    ...
    columns: {
        items: [
            { text: Strings.sharedName, dataIndex: "name", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "string" },
            { text: Strings.deviceIdentifier, dataIndex: "uniqueId", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "string" },
            { text: Strings.sharedPhone, dataIndex: "phone", flex: 1, minWidth: Traccar.Style.columnWidthNormal, hidden: !0, filter: "string" },
            { text: Strings.deviceModel, dataIndex: "model", flex: 1, minWidth: Traccar.Style.columnWidthNormal, hidden: !0, filter: "string" },
            { text: Strings.deviceContact, dataIndex: "contact", flex: 1, minWidth: Traccar.Style.columnWidthNormal, hidden: !0, filter: "string" },
            { text: Strings.sharedDisabled, dataIndex: "disabled", flex: 1, minWidth: Traccar.Style.columnWidthNormal, renderer: Traccar.AttributeFormatter.getFormatter("disabled"), hidden: !0, filter: "boolean" },
            {
                ...
                minWidth: Traccar.Style.columnWidthNormal,
                hidden: !0,
                filter: { type: "list", labelField: "name", store: "AllGroups" },
...
Ext.define("Traccar.view.permissions.Calendars", {
    ...
    columns: { items: [{ text: Strings.sharedName, dataIndex: "name", flex: 1, minWidth: Traccar.Style.columnWidthNormal, filter: "string" }] },
});
...
Ext.define("Traccar.view.edit.UsersController", {
    ...
    onDevicesClick: function() {
        ...
        Ext.create("Traccar.view.BaseWindow", {
            ...
            items: { xtype: "linkDevicesView", baseObjectName: "userId", linkObjectName: "deviceId", storeName: "AllDevices", linkStoreName: "Devices", baseObject: user.getId() },
        }).show();
    },
    onGroupsClick: function() {
        ...
        Ext.create("Traccar.view.BaseWindow", {
            ...
            items: { xtype: "linkGroupsView", baseObjectName: "userId", linkObjectName: "groupId", storeName: "AllGroups", linkStoreName: "Groups", baseObject: user.getId() },
        }).show();
    },
    onGeofencesClick: function() {
        var user = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedGeofences,
            items: { xtype: "linkGeofencesView", baseObjectName: "userId", linkObjectName: "geofenceId", storeName: "AllGeofences", linkStoreName: "Geofences", baseObject: user.getId() },
        }).show();
    },
    onNotificationsClick: function() {
        var user = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedNotifications,
            items: { xtype: "linkNotificationsView", baseObjectName: "userId", linkObjectName: "notificationId", storeName: "AllNotifications", linkStoreName: "Notifications", baseObject: user.getId() },
        }).show();
    },
    onCalendarsClick: function() {
        ...
        Ext.create("Traccar.view.BaseWindow", {
            ...
            items: { xtype: "linkCalendarsView", baseObjectName: "userId", linkObjectName: "calendarId", storeName: "AllCalendars", linkStoreName: "Calendars", baseObject: user.getId() },
        }).show();
    },
    ...
    onAttributesClick: function() {
        ...
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedComputedAttributes,
            items: { xtype: "linkComputedAttributesView", baseObjectName: "userId", linkObjectName: "attributeId", storeName: "AllComputedAttributes", linkStoreName: "ComputedAttributes", baseObject: user.getId() },
        }).show();
    },
    onDriversClick: function() {
        var user = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedDrivers,
            items: { xtype: "linkDriversView", baseObjectName: "userId", linkObjectName: "driverId", storeName: "AllDrivers", linkStoreName: "Drivers", baseObject: user.getId() },
        }).show();
    },
    onCommandsClick: function() {
        var user = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedSavedCommands,
            items: { xtype: "linkSavedCommandsView", baseObjectName: "userId", linkObjectName: "commandId", storeName: "AllCommands", linkStoreName: "Commands", baseObject: user.getId() },
        }).show();
    },
    onMaintenancesClick: function() {
        var user = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedMaintenance,
            items: { xtype: "linkMaintenancesView", baseObjectName: "userId", linkObjectName: "maintenanceId", storeName: "AllMaintenances", linkStoreName: "Maintenances", baseObject: user.getId() },
        }).show();
    },
    onSelectionChange: function(selection, selected) {
        ...
        this.lookupReference("userUsersButton").setDisabled(disabled || 0 === selected[0].get("userLimit"));
        this.callParent(arguments);
    },
});
Ext.define("Traccar.view.edit.Users", {
    ...
    tbar: {
        ...
        scrollable: !0,
        items: [
            { disabled: !0, handler: "onGeofencesClick", reference: "userGeofencesButton", glyph: "f279@FontAwesome", tooltip: Strings.sharedGeofences, tooltipType: "title" },
            { disabled: !0, handler: "onDevicesClick", reference: "userDevicesButton", glyph: "xf248@FontAwesome", tooltip: Strings.deviceTitle, tooltipType: "title" },
            { disabled: !0, handler: "onGroupsClick", reference: "userGroupsButton", glyph: "xf247@FontAwesome", tooltip: Strings.settingsGroups, tooltipType: "title" },
            { disabled: !0, handler: "onUsersClick", reference: "userUsersButton", glyph: "xf0c0@FontAwesome", tooltip: Strings.settingsUsers, tooltipType: "title" },
            { disabled: !0, handler: "onNotificationsClick", reference: "userNotificationsButton", glyph: "xf003@FontAwesome", tooltip: Strings.sharedNotifications, tooltipType: "title" },
            { disabled: !0, handler: "onCalendarsClick", reference: "userCalendarsButton", glyph: "xf073@FontAwesome", tooltip: Strings.sharedCalendars, tooltipType: "title" },
            { disabled: !0, handler: "onAttributesClick", reference: "userAttributesButton", glyph: "xf0ae@FontAwesome", tooltip: Strings.sharedComputedAttributes, tooltipType: "title" },
            { disabled: !0, handler: "onDriversClick", reference: "userDriversButton", glyph: "xf084@FontAwesome", tooltip: Strings.sharedDrivers, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onCommandsClick", reference: "userCommandsButton", glyph: "xf093@FontAwesome", tooltip: Strings.sharedSavedCommands, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onMaintenancesClick", reference: "userMaintenancesButton", glyph: "xf0ad@FontAwesome", tooltip: Strings.sharedMaintenance, tooltipType: "title" },
        ],
    },
    listeners: { selectionchange: "onSelectionChange" },
    columns: {
        ...
        items: [
            { text: Strings.sharedName, dataIndex: "name", filter: "string" },
            { text: Strings.userEmail, dataIndex: "email", filter: "string" },
            { text: Strings.userAdmin, dataIndex: "administrator", renderer: Traccar.AttributeFormatter.getFormatter("administrator"), filter: "boolean" },
            { text: Strings.serverReadonly, dataIndex: "readonly", hidden: !0, renderer: Traccar.AttributeFormatter.getFormatter("readonly"), filter: "boolean" },
            { text: Strings.userDeviceReadonly, dataIndex: "deviceReadonly", renderer: Traccar.AttributeFormatter.getFormatter("deviceReadonly"), hidden: !0, filter: "boolean" },
            { text: Strings.sharedDisabled, dataIndex: "disabled", renderer: Traccar.AttributeFormatter.getFormatter("disabled"), filter: "boolean" },
            { text: Strings.userExpirationTime, dataIndex: "expirationTime", hidden: !0, renderer: Traccar.AttributeFormatter.getFormatter("expirationTime"), filter: "date" },
        ],
    },
});
Ext.define("Traccar.view.dialog.Group", {
    ...
    items: {
        xtype: "form",
        items: [
            { xtype: "fieldset", title: Strings.sharedRequired, items: [{ xtype: "unescapedTextField", name: "name", fieldLabel: Strings.sharedName, allowBlank: !1 }] },
            {
                xtype: "fieldset",
                title: Strings.sharedExtra,
                collapsible: !0,
                collapsed: !0,
                items: [{ xtype: "clearableComboBox", name: "groupId", fieldLabel: Strings.groupParent, store: "Groups", queryMode: "local", displayField: "name", valueField: "id" }],
            },
        ],
    },
});
Ext.define("Traccar.view.edit.GroupsController", {
    ...
    onGeofencesClick: function() {
        ...
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedGeofences, items: { xtype: "linkGeofencesView", baseObjectName: "groupId", linkObjectName: "geofenceId", storeName: "Geofences", baseObject: group.getId() } }).show();
    },
    onAttributesClick: function() {
        var group = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedComputedAttributes,
            items: { xtype: "linkComputedAttributesView", baseObjectName: "groupId", linkObjectName: "attributeId", storeName: "ComputedAttributes", baseObject: group.getId() },
        }).show();
    },
    onDriversClick: function() {
        var group = this.getView().getSelectionModel().getSelection()[0];
    ...
    onCommandsClick: function() {
        ...
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedSavedCommands,
            items: { xtype: "linkSavedCommandsView", baseObjectName: "groupId", linkObjectName: "commandId", storeName: "Commands", baseObject: group.getId() },
        }).show();
    },
    onNotificationsClick: function() {
        var group = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedNotifications,
            items: { xtype: "linkNotificationsView", baseObjectName: "groupId", linkObjectName: "notificationId", storeName: "Notifications", baseObject: group.getId() },
        }).show();
    },
    onMaintenancesClick: function() {
        var group = this.getView().getSelectionModel().getSelection()[0];
        Ext.create("Traccar.view.BaseWindow", {
            title: Strings.sharedMaintenance,
            items: { xtype: "linkMaintenancesView", baseObjectName: "groupId", linkObjectName: "maintenanceId", storeName: "Maintenances", baseObject: group.getId() },
        }).show();
    },
    onSelectionChange: function(selection, selected) {
        var disabled = 0 === selected.length;
...
Ext.define("Traccar.view.edit.Groups", {
    ...
    tbar: {
        xtype: "editToolbar",
        items: [
            { xtype: "button", disabled: !0, handler: "onGeofencesClick", reference: "toolbarGeofencesButton", glyph: "f279@FontAwesome", tooltip: Strings.sharedGeofences, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onAttributesClick", reference: "toolbarAttributesButton", glyph: "xf0ae@FontAwesome", tooltip: Strings.sharedComputedAttributes, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onDriversClick", reference: "toolbarDriversButton", glyph: "xf084@FontAwesome", tooltip: Strings.sharedDrivers, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onCommandsClick", reference: "toolbarCommandsButton", glyph: "xf093@FontAwesome", tooltip: Strings.sharedSavedCommands, tooltipType: "title" },
            { xtype: "button", disabled: !0, handler: "onNotificationsClick", reference: "toolbarNotificationsButton", glyph: "xf003@FontAwesome", tooltip: Strings.sharedNotifications, tooltipType: "title" },
    ...
    columns: {
        ...
        items: [
            { text: Strings.sharedName, dataIndex: "name", filter: "string" },
            { text: Strings.groupDialog, dataIndex: "groupId", hidden: !0, filter: { type: "list", labelField: "name", store: "AllGroups" }, renderer: Traccar.AttributeFormatter.getFormatter("groupId") },
        ],
    },
});
Ext.define("Traccar.view.map.GeofenceMapController", {
    ...
    setMapState: function(lat, lon, zoom) {
        this.getView()
            .getMapView()
            .setCenter(ol.proj.fromLonLat([lon, lat]));
...
Ext.define("Traccar.view.map.GeofenceMap", {
    ...
    tbar: {
        items: [
            { xtype: "combobox", store: "GeofenceTypes", valueField: "key", displayField: "name", editable: !1, listeners: { select: "onTypeSelect" } },
            { xtype: "tbfill" },
            { glyph: "xf00c@FontAwesome", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, handler: "onSaveClick" },
            { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "onCancelClick" },
        ],
    },
    ...
    initMap: function() {
        ...
        new ol.layer.Vector({
            ...
            style: new ol.style.Style({
                fill: new ol.style.Fill({ color: geometry }),
                stroke: new ol.style.Stroke({ color: Traccar.Style.mapGeofenceColor, width: Traccar.Style.mapGeofenceWidth }),
                image: new ol.style.Circle({ radius: Traccar.Style.mapGeofenceRadius, fill: new ol.style.Fill({ color: Traccar.Style.mapGeofenceColor }) }),
            }),
        }).setMap(map);
        map.addInteraction(
    ...
    removeInteraction: function() {
        this.draw && (this.map.removeInteraction(this.draw), (this.draw = null));
    },
});
Ext.define("Traccar.view.dialog.GeofenceController", {
    ...
    init: function() {
        this.lookupReference("calendarCombo").setHidden(Traccar.app.getBooleanAttributePreference("ui.disableCalendars"));
    },
...
Ext.define("Traccar.view.dialog.Geofence", {
    ...
    items: {
        xtype: "form",
        items: [
            { xtype: "fieldset", title: Strings.sharedRequired, items: [{ xtype: "unescapedTextField", name: "name", fieldLabel: Strings.sharedName }] },
            {
                xtype: "fieldset",
                title: Strings.sharedExtra,
                collapsible: !0,
                ...
                items: [
                    { xtype: "unescapedTextField", name: "description", fieldLabel: Strings.sharedDescription },
                    { xtype: "clearableComboBox", reference: "calendarCombo", name: "calendarId", store: "Calendars", queryMode: "local", displayField: "name", valueField: "id", fieldLabel: Strings.sharedCalendar },
    ...
    buttons: [
        { text: Strings.sharedArea, glyph: "f279@FontAwesome", handler: "onAreaClick" },
        { text: Strings.sharedAttributes, handler: "showAttributesView" },
        { xtype: "tbfill" },
        { glyph: "xf00c@FontAwesome", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, handler: "onSaveClick" },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
...
Ext.define("Traccar.view.edit.Geofences", {
    ...
    columns: {
        ...
        items: [
            { text: Strings.sharedName, dataIndex: "name", filter: "string" },
            { text: Strings.sharedDescription, dataIndex: "description", filter: "string" },
            { text: Strings.sharedCalendar, dataIndex: "calendarId", hidden: !0, filter: { type: "list", labelField: "name", store: "AllCalendars" }, renderer: Traccar.AttributeFormatter.getFormatter("calendarId") },
        ],
    },
});
...
Ext.define("Traccar.view.edit.Drivers", {
    ...
    columns: {
        ...
        items: [
            { text: Strings.sharedName, dataIndex: "name", filter: "string" },
            { text: Strings.deviceIdentifier, dataIndex: "uniqueId", filter: "string" },
        ],
    },
});
Ext.define("Traccar.view.dialog.NotificationController", {
    ...
    onTypeChange: function(view, value) {
        this.lookupReference("alarmsField").setHidden("alarm" !== value);
    },
    onAlarmsLoad: function(view) {
        var attributes = view.up("form").getRecord().get("attributes") || {};
        attributes.alarms && (view.suspendEvents(!1), view.setValue(attributes.alarms.split(",")), view.resumeEvents());
    },
    ...
    items: {
        ...
        items: [{
                ...
                items: [{
                    ...
                    { xtype: "checkboxfield", inputValue: !0, uncheckedValue: !1, name: "always", fieldLabel: Strings.notificationAlways },
                    {
                        xtype: "tagfield",
                        ...
                        queryMode: "local",
                        hidden: !0,
                        listeners: { beforerender: "onAlarmsLoad", change: "onAlarmsChange" },
                    },
                    { xtype: "tagfield", fieldLabel: Strings.notificationNotificators, name: "notificators", maxWidth: Traccar.Style.formFieldWidth, store: "AllNotificators", valueField: "type", displayField: "name", queryMode: "local" },
                ],
            },
            {
                xtype: "fieldset",
...
Ext.define("Traccar.view.StatisticsController", {
    ...
    onShowClick: function() {
        Ext.getStore("Statistics").load({ params: { from: this.lookupReference("fromDateField").getValue().toISOString(), to: this.lookupReference("toDateField").getValue().toISOString() } });
    },
});
Ext.define("Traccar.view.Statistics", {
    ...
    tbar: {
        scrollable: !0,
        items: [
            { xtype: "tbtext", html: Strings.reportFrom },
            { xtype: "datefield", reference: "fromDateField", startDay: Traccar.Style.weekStartDay, format: Traccar.Style.dateFormat, value: new Date(new Date().getTime() - 864e5) },
            "-",
            { xtype: "tbtext", html: Strings.reportTo },
            { xtype: "datefield", reference: "toDateField", startDay: Traccar.Style.weekStartDay, format: Traccar.Style.dateFormat, value: new Date() },
            "-",
    ...
    columns: {
        defaults: { flex: 1, minWidth: Traccar.Style.columnWidthNormal },
        items: [
            { text: Strings.statisticsCaptureTime, dataIndex: "captureTime", xtype: "datecolumn", renderer: Traccar.AttributeFormatter.defaultFormatter() },
            { text: Strings.statisticsActiveUsers, dataIndex: "activeUsers" },
            { text: Strings.statisticsActiveDevices, dataIndex: "activeDevices" },
            { text: Strings.statisticsRequests, dataIndex: "requests" },
            { text: Strings.statisticsMessagesReceived, dataIndex: "messagesReceived" },
            { text: Strings.statisticsMessagesStored, dataIndex: "messagesStored" },
            { text: Strings.notificatorMail, dataIndex: "mailSent" },
            { text: Strings.notificatorSms, dataIndex: "smsSent" },
            { text: Strings.statisticsGeocoder, dataIndex: "geocoderRequests" },
            { text: Strings.statisticsGeolocation, dataIndex: "geolocationRequests" },
        ],
    },
});
        ...
        if (0 < fileField.fileInputEl.dom.files.length) {
            ...
            reader.onload = function(event) {
                fileField
                    ...
                    .setValue(event.target.result.substr(event.target.result.indexOf(",") + 1));
            };
        ...
        items: [{
                ...
                items: [
                    { xtype: "unescapedTextField", name: "name", fieldLabel: Strings.sharedName, allowBlank: !1 },
                    {
                        ...
                        allowBlank: !1,
                        buttonConfig: { glyph: "xf093@FontAwesome", text: "", tooltip: Strings.sharedSelectFile, tooltipType: "title", minWidth: 0 },
                        listeners: { change: "onFileChange" },
                    },
                ],
            },
...
Ext.define("Traccar.view.edit.Calendars", {
    ...
    tbar: { xtype: "editToolbar" },
    listeners: { selectionchange: "onSelectionChange" },
    columns: { defaults: { flex: 1, minWidth: Traccar.Style.columnWidthNormal }, items: [{ text: Strings.sharedName, dataIndex: "name", filter: "string" }] },
});
Ext.define("Traccar.view.dialog.SavedCommand", {
    ...
    items: [{
        ...
        items: [{
            ...
            items: [
                { xtype: "unescapedTextField", name: "description", fieldLabel: Strings.sharedDescription },
                { xtype: "checkboxfield", name: "textChannel", inputValue: !0, uncheckedValue: !1, fieldLabel: Strings.commandSendSms },
                {
                    xtype: "combobox",
                    name: "type",
                    reference: "commandType",
    ...
    buttons: [
        { glyph: "xf00c@FontAwesome", reference: "saveButton", tooltip: Strings.sharedSave, tooltipType: "title", minWidth: 0, disabled: !0, handler: "onSaveClick" },
        { glyph: "xf00d@FontAwesome", tooltip: Strings.sharedCancel, tooltipType: "title", minWidth: 0, handler: "closeView" },
    ],
});
...
Ext.define("Traccar.view.edit.SavedCommands", {
    ...
    columns: {
        ...
        items: [
            { text: Strings.sharedDescription, dataIndex: "description", filter: "string" },
            { text: Strings.sharedType, dataIndex: "type", filter: { type: "list", idField: "type", labelField: "name", store: "AllCommandTypes" }, renderer: Traccar.AttributeFormatter.getFormatter("commandType") },
...
Ext.define("Traccar.view.dialog.MaintenanceController", {
    ...
    updateFieldConfig: function(fieldReference, initialConfig, newConfig) {
        ...
        field.dataType !== newConfig.dataType ?
            (this.getView().down("fieldset").insert(this.getView().down("fieldset").items.indexOf(field), Ext.merge({}, initialConfig, newConfig)),
                this.getView().down("fieldset").remove(field),
                this.lookupReference(fieldReference).validate()) :
            (field.setConfig(newConfig), field.validate());
    },
    onNameChange: function(combobox, newValue) {
        var config = {};
        if ((combobox = combobox.getStore().getById(newValue)))
            void 0 !== combobox.get("allowDecimals") ? (config.allowDecimals = combobox.get("allowDecimals")) : (config.allowDecimals = !0),
            (config.dataType = combobox.get("dataType")),
            (config.maxValue = combobox.get("maxValue")),
            (config.minValue = combobox.get("minValue"));
    ...
    items: {
        ...
        items: [{
            ...
            items: [
                ...
                { xtype: "customNumberField", name: "start", reference: "startField", fieldLabel: Strings.maintenanceStart },
                {
                    xtype: "customNumberField",
                    name: "period",
                    ...
                    validator: function(value) {
                        return 0 !== this.parseValue(value) ? !0 : Strings.errorZero;
                    },
                },
            ],
        }, ],
...
Ext.define("Traccar.view.SettingsMenuController", {
    ...
    init: function() {
        ...
        admin &&
            (this.lookupReference("settingsServerButton").setHidden(!1),
                this.lookupReference("settingsStatisticsButton").setHidden(!1),
                this.lookupReference("settingsComputedAttributesButton").setHidden(Traccar.app.getBooleanAttributePreference("ui.disableComputedAttributes")));
        (admin || manager) && this.lookupReference("settingsUsersButton").setHidden(!1);
        if (admin || !readonly)
            this.lookupReference("settingsUserButton").setHidden(!1),
            this.lookupReference("settingsGroupsButton").setHidden(!1),
            this.lookupReference("settingsGeofencesButton").setHidden(!1),
            this.lookupReference("settingsNotificationsButton").setHidden(!1),
            ...
            this.lookupReference("settingsCommandsButton").setHidden(Traccar.app.getPreference("limitCommands", !1)),
            this.lookupReference("settingsMaintenancesButton").setHidden(Traccar.app.getVehicleFeaturesDisabled() || Traccar.app.getBooleanAttributePreference("ui.disableMaintenance"));
    },
    ...
    onGroupsClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.settingsGroups, items: { xtype: "groupsView" } }).show();
    },
    onGeofencesClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedGeofences, items: { xtype: "geofencesView" } }).show();
    },
    ...
    onUsersClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.settingsUsers, items: { xtype: "usersView" } }).show();
    },
    onNotificationsClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedNotifications, items: { xtype: "notificationsView" } }).show();
    },
    onComputedAttributesClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedComputedAttributes, items: { xtype: "computedAttributesView" } }).show();
    },
    onStatisticsClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.statisticsTitle, items: { xtype: "statisticsView" } }).show();
    },
    onCalendarsClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedCalendars, items: { xtype: "calendarsView" } }).show();
    },
    onDriversClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedDrivers, items: { xtype: "driversView" } }).show();
    },
    onCommandsClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedSavedCommands, items: { xtype: "savedCommandsView" } }).show();
    },
    onMaintenancesClick: function() {
        Ext.create("Traccar.view.BaseWindow", { title: Strings.sharedMaintenance, items: { xtype: "maintenancesView" } }).show();
    },
...
Ext.define("Traccar.view.SettingsMenu", {
    ...
    menu: {
        controller: "settings",
        items: [
            { hidden: !0, text: Strings.settingsUser, glyph: "xf007@FontAwesome", handler: "onUserClick", reference: "settingsUserButton" },
            { hidden: !0, text: Strings.settingsGroups, glyph: "xf247@FontAwesome", handler: "onGroupsClick", reference: "settingsGroupsButton" },
            { hidden: !0, text: Strings.sharedDrivers, glyph: "xf084@FontAwesome", handler: "onDriversClick", reference: "settingsDriversButton" },
            { hidden: !0, text: Strings.sharedGeofences, glyph: "f279@FontAwesome", handler: "onGeofencesClick", reference: "settingsGeofencesButton" },
            { hidden: !0, text: Strings.settingsServer, glyph: "xf233@FontAwesome", handler: "onServerClick", reference: "settingsServerButton" },
            { hidden: !0, text: Strings.settingsUsers, glyph: "xf0c0@FontAwesome", handler: "onUsersClick", reference: "settingsUsersButton" },
            { hidden: !0, text: Strings.sharedNotifications, glyph: "xf003@FontAwesome", handler: "onNotificationsClick", reference: "settingsNotificationsButton" },
            { hidden: !0, text: Strings.sharedComputedAttributes, glyph: "xf0ae@FontAwesome", handler: "onComputedAttributesClick", reference: "settingsComputedAttributesButton" },
            { hidden: !0, text: Strings.statisticsTitle, glyph: "xf080@FontAwesome", handler: "onStatisticsClick", reference: "settingsStatisticsButton" },
            { hidden: !0, text: Strings.sharedCalendars, glyph: "xf073@FontAwesome", handler: "onCalendarsClick", reference: "settingsCalendarsButton" },
            { hidden: !0, text: Strings.sharedSavedCommands, glyph: "xf093@FontAwesome", handler: "onCommandsClick", reference: "settingsCommandsButton" },
            { hidden: !0, text: Strings.sharedMaintenance, glyph: "xf0ad@FontAwesome", handler: "onMaintenancesClick", reference: "settingsMaintenancesButton" },
...
Ext.define("Traccar.view.map.Map", {
    ...
    tbar: {
        ...
        defaults: { xtype: "button", tooltipType: "title", stateEvents: ["toggle"], enableToggle: !0, stateful: { pressed: !0 } },
        items: [
            { xtype: "tbtext", html: Strings.mapTitle, baseCls: "x-panel-header-title-default" },
            { xtype: 'image', src: '../../../ubik_nn.png', width: 50, height: 30 },
            { xtype: "tbfill" },
            { handler: "showReports", reference: "showReportsButton", glyph: "xf0f6@FontAwesome", stateful: !1, enableToggle: !1, tooltip: Strings.reportTitle },
            { handler: "showEvents", reference: "showEventsButton", glyph: "xf0ca@FontAwesome", stateful: !1, enableToggle: !1, tooltip: Strings.reportEvents },
            { handler: "updateGeofences", reference: "showGeofencesButton", glyph: "f279@FontAwesome", pressed: !0, stateId: "show-geofences-button", tooltip: Strings.sharedGeofences },
            { handler: "showLiveRoutes", reference: "showLiveRoutes", glyph: "xf1b9@FontAwesome", stateId: "show-live-routes-button", tooltip: Strings.mapLiveRoutes },
            { reference: "deviceFollowButton", glyph: "xf124@FontAwesome", tooltip: Strings.deviceFollow, stateId: "device-follow-button", toggleHandler: "onFollowClick" },
    ...
    initMap: function() {
        ...
        this.map.addLayer(new ol.layer.Vector({ name: "accuracyLayer", source: this.accuracySource }));
...
Ext.define("Traccar.view.Main", {
    ...
    items: [{
            ...
            defaults: { split: !0, flex: 1 },
            items: [
                { region: "center", xtype: "devicesView" },
                { region: "south", xtype: "stateView" },
            ],
        },
        { region: "south", xtype: "reportView", reference: "reportView", height: Traccar.Style.reportHeight, collapsed: !0, titleCollapse: !0, floatable: !1 },
        { region: "center", xtype: "mapView", collapsible: !1 },
        { region: "east", xtype: "eventsView", reference: "eventsView", width: Traccar.Style.deviceWidth, collapsed: !0, titleCollapse: !0, floatable: !1 },
    ],
});
Ext.define("Traccar.view.MainMobile", {
    ...
    items: [{
            ...
            defaults: { header: !1, collapsible: !0, split: !0 },
            items: [
                { region: "east", xtype: "stateView", title: Strings.stateTitle, flex: 4, collapsed: !0, collapseMode: "mini", titleCollapse: !0, floatable: !1, stateId: "mobile-state-grid" },
                { region: "center", xtype: "mapView", collapsible: !1, flex: 2 },
                { region: "south", xtype: "devicesView", title: Strings.deviceTitle, flex: 1, collapsed: !0, titleCollapse: !0, floatable: !1, stateId: "mobile-devices-grid" },
            ],
        },
        { xtype: "reportView" },
        { xtype: "eventsView" },
...
Ext.define("Traccar.controller.Root", {
    ...
    init: function() {
        ...
        for (i = 0; i < data.length; i++) {
            var attribute = data[i];
            Traccar.model.Position.addFields([{ name: "attribute." + attribute.get("key"), attributeKey: attribute.get("key"), calculate: this.calculateAttribute, persist: !1 }]);
    ...
    calculateAttribute: function(data) {
        data = data.attributes[this.attributeKey];
        return void 0 !== data ? Traccar.AttributeFormatter.getAttributeConverter(this.attributeKey)(data) : data;
    },
    onLaunch: function() {
    ...
    loadApp: function() {
        ...
        (updateView = Ext.get("update")) && updateView.remove();
        (updateView = Ext.get("attribution")) && updateView.remove();
        Traccar.app.isMobile() ? Ext.create("widget.mainMobile") : Ext.create("widget.main");
        if ((updateView = Ext.Object.fromQueryString(window.location.search).eventId)) this.fireEvent("showsingleevent", updateView), this.removeUrlParameter("eventId");
    },
    beep: function() {
    ...
    updatePositions: function(array, first) {
        ...
        for (i = 0; i < array.length; i++)
            (entity = store.findRecord("deviceId", array[i].deviceId, 0, !1, !1, !0)) ? entity.set(array[i]) : store.add(Ext.create("Traccar.model.Position", array[i])),
            Ext.getStore("Events").findRecord("positionId", array[i].id, 0, !1, !1, !0) && Ext.getStore("EventPositions").add(Ext.create("Traccar.model.Position", array[i]));
        first &&
            ((array = Ext.Object.fromQueryString(window.location.search).deviceId) && (device = Ext.getStore("VisibleDevices").findRecord("id", array, 0, !1, !0, !0)) && this.fireEvent("selectdevice", device, !0),
                device || this.zoomToAllDevices());
    },
    updateEvents: function(array) {
        var i, device;
        var store = Ext.getStore("Events");
        for (i = 0; i < array.length; i++)
            store.add(array[i]), (device = Ext.getStore("Devices").getById(array[i].deviceId)) ? (this.soundPressed() && this.beep(), Traccar.app.showToast(array[i].text, device.get("name"))) : Traccar.app.showToast(array[i].text);
    },
    zoomToAllDevices: function() {
...
Ext.define("Traccar.Application", {
    ...
    getEventString: function(eventType) {
        eventType = "event" + eventType.charAt(0).toUpperCase() + eventType.slice(1);
        return Strings[eventType] || eventType;
    },
    getNotificatorString: function(eventType) {
        eventType = "notificator" + eventType.charAt(0).toUpperCase() + eventType.slice(1);
        return Strings[eventType] || eventType;
    },
    ...
    updateNotificationToken: function(token) {
        ...
        if (!attributes.notificationTokens || 0 > attributes.notificationTokens.indexOf(token))
            (attributes.notificationTokens = attributes.notificationTokens ? attributes.notificationTokens + ("," + token) : token), this.user.set("attributes", attributes), this.user.save();
    },
    setUser: function(data) {
        this.user = Ext.create("Ext.data.reader.Json", { model: "Traccar.model.User" }).readRecords(data).getRecords()[0];
    },
    getUser: function() {
        return this.user;
    },
    setServer: function(data) {
        this.server = Ext.create("Ext.data.reader.Json", { model: "Traccar.model.Server" }).readRecords(data).getRecords()[0];
    },
    getServer: function() {
        return this.server;
    },
    getPreference: function(key, defaultValue) {
        return this.getServer().get("forceSettings") ? this.getServer().get(key) || this.getUser().get(key) || defaultValue : this.getUser().get(key) || this.getServer().get(key) || defaultValue;
    },
    getAttributePreference: function(key, defaultValue) {
        return this.getServer().get("forceSettings") ?
            this.getServer().get("attributes")[key] || this.getUser().get("attributes")[key] || defaultValue :
            this.getUser().get("attributes")[key] || this.getServer().get("attributes")[key] || defaultValue;
    },
    getBooleanAttributePreference: function(key) {
        return "true" === this.getAttributePreference(key, !1).toString();
    },
    ...
    showError: function(error) {
        Ext.isString(error) ?
            ...
            error.responseText ?
            Ext.Msg.alert(Strings.errorTitle, Strings.errorGeneral + '\x3cbr\x3e\x3cbr\x3e\x3ctextarea readonly rows\x3d"5" style\x3d"resize: none; width: 100%;"\x3e' + error.responseText + "\x3c/textarea\x3e") :
            error.statusText ?
    ...
    showToast: function(message, title) {
        Ext.toast({ html: message, title: title, width: Traccar.Style.toastWidth, align: "br" });
    },
});
